...
- [x] T024 [US3] Reproduce the actual Pages staging rejection on 9502fc46; add a collector-to-release-verifier regression with retained tamper rejection before changing the collector to existing Workbox MD5 cache identifiers. Preserve SHA-256 artifact seals and all release guards. Rerun full tests, release neighbors/contracts, actual prepare/stage/integrity/privacy checks and the prepared/staged offline journeys. Fresh exact-head publication remains under T014–T015.
