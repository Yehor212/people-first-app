...
- No permanent remote journal-entry lifecycle registry or deletion RPC ships in this wave, so rollback must not assume or fabricate such a ledger. Existing client tombstones and retryable owner-scoped deletes remain in force.
