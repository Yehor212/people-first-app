...
- The unchecked measurable-outcomes row is an implementation/runtime gate, not a defect in the written specification. Local contracts are implemented, but real-account recovery, live Supabase execution, exact-head CI, public runtime, physical devices, native assistive technology, Windows runtime, and human animation approval remain `UNVERIFIED`.
