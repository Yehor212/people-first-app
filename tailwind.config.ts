...
export default {
  ...
  content: {
    files: [
      ...
      "!./src/storage/**/*.{ts,tsx}",
      "!./src/types/**/*.{ts,tsx}",
      // Knip-confirmed legacy UI surfaces stay out of Tailwind scanning so
      ...
      "!./src/components/habit-tracker/**/*.{ts,tsx}",
      ...
      "!./src/components/HabitCompletionCelebration.tsx",
      "!./src/components/HabitCreationForm.tsx",
      "!./src/components/HabitTracker.tsx",
      "!./src/components/JournalPrompt.tsx",
      "!./src/components/MoodSelectionCelebration.tsx",
