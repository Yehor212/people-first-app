...
import { checkTelegramBotProfilePhoto } from "../src/telegram-readiness";

const args = process.argv.slice(2);
const required =
  args.includes("--required") || process.env.ZENFLOW_TELEGRAM_BOT_PROFILE_PHOTO_REQUIRED === "true";
...
console.log(`[telegram-bot-profile-photo] ${check.status} ${check.evidence}`);
