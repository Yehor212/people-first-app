...
| 5 | Sync contract invariant | `npm run check:sync-contract`, including `runWithSyncLeaderLock()` for multi-tab delta ownership | Yes for sync, storage, Supabase, backup, offline queue, or hydration work |
