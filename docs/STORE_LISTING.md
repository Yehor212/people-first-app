...
Приватный трекер привычек, настроения, фокуса и благодарности.

## Полное описание
ZenFlow помогает мягко выстраивать ежедневные ритуалы: отметки настроения,
привычки, фокус‑сессии и дневник благодарности. Приложение работает офлайн,
а данные по умолчанию остаются на устройстве. При необходимости можно включить
синхронизацию для переноса данных между устройствами.

Ключевые возможности:
- Отметки настроения и тенденции
- Привычки с гибкими типами
- Фокус‑таймер и рефлексия
- Дневник благодарности
- Локальные напоминания
- Экспорт и импорт данных

## Ключевые слова
привычки, настроение, фокус, благодарность, офлайн, трекер
