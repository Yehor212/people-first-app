...
export async function buildCurrentArtifactManifest(rootDir) {
  ...
  const artifactPaths = {
    ...
    assurance_protocol: "docs/ai/TEN_LENS_EVIDENCE_ASSURANCE_V2_2_1.md",
    ...
    assurance_core: "scripts/persistent-agent-orchestra/assurance-core.mjs",
    assurance_runner: "scripts/run-ten-lens-assurance.mjs",
    rag_corpus_manifest: "scripts/rag/corpus-manifest.json",
