...
const passFactsByItem: Record<string, Record<string, boolean>> = {
  ...
  admob_policy_center: { policyCenterReviewed: true, noViolations: true, noBlockingIssues: true, noRegulatoryIssues: true, noAdvertiserPreferenceRestrictions: true, noRestrictedOrDisabledAdRequests: true },
  privacy_messages_cmp: {
