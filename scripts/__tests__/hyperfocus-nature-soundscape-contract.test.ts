...
describe("hyperfocus nature soundscape generation contract", () => {
  ...
  it("builds a one-job pilot queue before the full pack", () => {
    ...
    expect(pilot.jobs[0]).toMatchObject({
      id: "fireplace:soft",
  ...
  it("rejects prompts that steer Lyria toward songs, pop, or celebrity-style music", () => {
    const badSpec = {
      modelPolicy: {
        requiredProvider: "Google Gemini/Lyria family only",
        preferredPilotModel: "lyria-3-clip",
          ...
          levels: [
            {
              ...
              fileName: "hyperfocus-fireplace-soft.mp3",
              prompt:
                "Create a catchy BTS-style pop song about a fireplace with vocals, chorus, and melody.",
              rejectIf: [
                "vocals or lyrics",
                "melody or tune",
                "beat, drums, or percussion",
                "instruments or synth",
                "song structure, chorus, verse, or drop",
                "pop or commercial music soundtrack",
                "bad loop seam",
                "clipping, harsh transient, or click",
              ],
            },
            {
              id: "deep",
              ...
              prompt:
                "Create a 30-second seamless loop field-recording environmental soundscape for concentration, nature fireplace crackle, steady from first second to last second, no vocals, no lyrics, no melody, no beat, no drums, no instruments, no song structure.",
              rejectIf: [
                "vocals or lyrics",
                "melody or tune",
                "beat, drums, or percussion",
