export type SensitiveAdvertisingSurface = "auth" | "orb" | "habits" | "diary" | "planning" | "settings" | "error" | "navigation" | "overlay";
...
export const SENSITIVE_ADVERTISING_SCENARIOS = [
  ...
  { id: "navigation.drawer-command-palette", surface: "navigation", sourcePath: "src/components/navigation-v2/NavV2Orchestrator.tsx", sourceNeedle: "commandPaletteOpen || drawerOpen" },
