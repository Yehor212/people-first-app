...
const REQUIRED_RUNBOOK_SNIPPETS = [
  ...
  "fallback review instead of claiming those translations",
  ...
  "noRegulatoryIssues",
  "noAdvertiserPreferenceRestrictions",
  "noRestrictedOrDisabledAdRequests",
  ...
  "no advertiser-preference restrictions",
  "no restricted or disabled ad requests",
  "ZenFlow CMP languages en, uk, es, de, fr, and ja all reviewed and available",
  "Google supported-language list reviewed",
  "Arabic/Hebrew European regulations fallback reviewed without claiming unavailable translations",
  "If any Google-supported language is unavailable, missing, not offered, or not reviewed, or if the Arabic/Hebrew fallback is not documented, keep `privacy_messages_cmp` non-PASS.",
  ...
  "IP address disclosure reviewed",
  "device or other identifiers disclosure reviewed",
  "samePublisherFamily",
];
