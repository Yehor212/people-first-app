...
describe('habitToScheduleEvents', () => {
  ...
  it('sets the complete dedicated-block ownership markers', () => {
    const habit = makeHabit({
      id: 'h1',
      name: 'Code',
...
describe('mergeScheduleEvents', () => {
  ...
  it('keeps one authoritative persisted completed block instead of duplicating its generated copy', () => {
    const generated: ScheduleEvent = {
      ...baseEvent,
      id: 'habit-h1-2025-06-16-0',
      title: 'Read',
      source: 'habit',
      habitId: 'h1',
    ...
    const persisted: ScheduleEvent = {
      ...generated,
      completed: true,
      completedAt: 1_750_067_400_000,
    };

    const merged = mergeScheduleEvents([persisted], [generated]);
