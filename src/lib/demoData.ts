...
/** Convert an array of date strings into an entries Record with YES_MANUAL (2) */
function datesToEntries(dates: string[]): Record<string, { value: number }> {
  const entries: Record<string, { value: number }> = {};
  for (const d of dates) entries[d] = { value: 2 };
  return entries;
}
...
const demoHabits: Habit[] = [
  {
    ...
    reminders: [],
    entries: datesToEntries(lastNDays(14)),
  ...
  },
  {
    ...
    frequency: { numerator: 1, denominator: 1 },
    reminders: [],
    entries: datesToEntries(lastNDays(7)),
  ...
  },
  {
    ...
    frequency: { numerator: 1, denominator: 1 },
    reminders: [],
    entries: datesToEntries(lastNDaysExceptToday(10)),
  ...
  },
  {
    ...
    frequency: { numerator: 1, denominator: 1 },
    reminders: [],
    entries: datesToEntries(lastNDays(5)),
