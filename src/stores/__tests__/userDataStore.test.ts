...
function makeGratitudeEntry(overrides: Partial<GratitudeEntry> = {}): GratitudeEntry {
  return { id: 'g1', text: 'Grateful for tests', date: '2025-01-01', timestamp: 1000, ...overrides };
}
...
describe('userDataStore initial state', () => {
  ...
  it('googleAuthChecked defaults to false', () => {
...
describe('direct value setters', () => {
  ...
  it('setGoogleAuthChecked sets googleAuthChecked', () => {
