      ...
      <div className="w-full max-w-md motion-safe:animate-fade-in">
        ...
        >
          ...
          <button
            ...
            disabled={session.isLoading || !supabase}
            aria-label={session.loadingProvider === 'apple' ? t.authSigningIn : t.continueWithApple}
            aria-disabled={session.isLoading || !supabase}
          ...
          <button
            ...
            disabled={session.isLoading || !supabase}
            aria-label={session.loadingProvider === 'facebook' ? t.authSigningIn : t.continueWithFacebook}
            aria-disabled={session.isLoading || !supabase}
