...
export function CalendarGrid({
  calendarDays, moodByDate, focusMinutesByDate, habitCompletionMap, gratitudeByDate,
  todayKey, selectedDate, onSelectDate, monthNames, selectedMonth, selectedYear, t,
}: CalendarGridProps) {
  return (
    <>
      {/* Day Names */}
