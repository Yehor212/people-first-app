      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 inset-x-0 z-[61] max-h-[80dvh] rounded-t-[2rem] bg-card border-t border-border overflow-y-auto pb-[calc(env(safe-area-inset-bottom,0px)+1rem)] lg:max-w-4xl lg:mx-auto"
          >
            {/* Handle bar */}
