...
export const CHANGELOG: Record<string, ChangelogItem[]> = {
  "1.7.2": [
    ...
    {
      icon: <Bug className="w-5 h-5 text-orange-500" aria-hidden="true" />,
  ...
  "1.7.1": [
    {
      icon: <Shield className="w-5 h-5 text-green-500" aria-hidden="true" />,
  ...
  "1.7.0": [
    {
      icon: <Sparkles className="w-5 h-5 text-purple-500" aria-hidden="true" />,
    ...
    {
      icon: <MessageSquare className="w-5 h-5 text-blue-500" aria-hidden="true" />,
    ...
    {
      icon: <Settings className="w-5 h-5 text-indigo-500" aria-hidden="true" />,
  ...
  "1.5.7": [
    {
      icon: (
        <ToggleRight className="w-5 h-5 text-purple-500" aria-hidden="true" />
      ),
  ...
  "1.3.5": [
    ...
    {
      icon: <RefreshCw className="w-5 h-5 text-blue-500" aria-hidden="true" />,
  ...
  "1.3.0": [
    ...
    {
      icon: <Zap className="w-5 h-5 text-green-500" aria-hidden="true" />,
    ...
    {
      icon: <RefreshCw className="w-5 h-5 text-orange-500" aria-hidden="true" />,
  ...
  "1.2.0": [
    ...
    {
      icon: <Download className="w-5 h-5 text-blue-500" aria-hidden="true" />,
    ...
    {
      icon: <Moon className="w-5 h-5 text-purple-500" aria-hidden="true" />,
  ...
  "1.2.1": [
    ...
    {
      icon: <MessageSquare className="w-5 h-5 text-green-500" aria-hidden="true" />,
