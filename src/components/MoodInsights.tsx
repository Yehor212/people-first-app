    ...
    <div className="space-y-3">
      ...
      >
        ...
        <button
          ...
          className="absolute top-3 end-3 p-1.5 min-w-[44px] min-h-[44px] flex items-center justify-center hover:bg-foreground/10 rounded-lg motion-safe:transition-colors"
        >
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  aria-label={t.insightsDismiss || "Dismiss insight"}
                  className="absolute top-2 end-2 p-1 min-w-[44px] min-h-[44px] flex items-center justify-center hover:bg-foreground/10 rounded-lg motion-safe:transition-colors"
                >
