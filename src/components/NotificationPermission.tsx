...
export function NotificationPermission({ onComplete }: NotificationPermissionProps) {
  ...
  return (
    <div
      className="fixed inset-0 bg-background/95 backdrop-blur-sm z-[60] flex items-center justify-center p-4 animate-fade-in lg:mx-auto lg:my-8 lg:max-w-2xl lg:rounded-2xl lg:shadow-2xl"
      role="dialog"
      aria-modal="true"
