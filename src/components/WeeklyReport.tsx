...
export const WeeklyReport = memo(function WeeklyReport({
  ...
  return (
    <>
      {/* Desktop backdrop */}
      {/* A11Y-OK: decorative backdrop overlay, aria-hidden removes from accessibility tree */}
      <div
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm md:mx-auto md:my-6 md:max-w-lg md:rounded-2xl md:shadow-2xl"
        role="dialog"
        aria-modal="true"
