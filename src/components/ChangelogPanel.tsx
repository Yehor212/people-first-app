...
export function ChangelogPanel({ onClose }: ChangelogPanelProps) {
  ...
  return (
    <div
      className="fixed inset-0 md:inset-y-6 md:left-auto md:right-auto md:w-full md:mx-auto md:max-w-2xl md:rounded-2xl md:shadow-2xl z-[80] bg-background motion-safe:animate-fade-in overflow-hidden flex flex-col"
      role="dialog"
      aria-modal="true"
