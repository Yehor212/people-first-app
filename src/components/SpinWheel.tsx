...
export function SpinWheel({ onClose, onWin, spinsAvailable }: SpinWheelProps) {
  ...
  return (
    <div
      className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[60] flex items-center justify-center p-4 md:inset-y-6 md:left-auto md:right-auto md:w-full md:mx-auto md:max-w-lg md:rounded-2xl md:shadow-2xl"
      role="dialog"
      aria-modal="true"
    >
