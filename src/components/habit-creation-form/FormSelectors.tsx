...
export function IconSelector({ selectedIcon, setSelectedIcon, isPrimaryCTA, ts }: IconSelectorProps) {
  return (
    <div className="relative mb-4">
      <p className={cn("text-sm font-medium mb-2", isPrimaryCTA ? "text-slate-700 dark:text-foreground/80" : "text-foreground")} id="icon-selector-label">{ts.icon || 'Icon'}:</p>
...
export function ColorSelector({ selectedColorIndex, setSelectedColorIndex, isPrimaryCTA, ts }: ColorSelectorProps) {
  return (
    <div className="relative mb-4">
      <p className={cn("text-sm font-medium mb-2", isPrimaryCTA ? "text-slate-700 dark:text-foreground/80" : "text-foreground")} id="color-selector-label">{ts.color || 'Color'}:</p>
...
export function TypeSelector({ habitType, setHabitType, isPrimaryCTA, ts }: TypeSelectorProps) {
  return (
    <div className="relative mb-4">
      <p className={cn("text-sm font-medium mb-2", isPrimaryCTA ? "text-slate-700 dark:text-foreground/80" : "text-foreground")}>{ts.habitType || 'Type'}:</p>
...
export function FrequencySelector({ frequency, setFrequency, isPrimaryCTA, ts }: FrequencySelectorProps) {
...
export function CategorySelector({ selectedCategory, setSelectedCategory, isPrimaryCTA, ts }: CategorySelectorProps) {
