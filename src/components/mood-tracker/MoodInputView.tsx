...
export function MoodInputView({
  moods, timeLabels, currentTimeOfDay, isPrimaryCTA, hasAnyEntryToday, t,
  selectedMood, onSelectMood, note, onNoteChange, onSubmit,
  showAddNew, onBack, moodButtonRefs,
  showCelebration, celebrationData, onCelebrationComplete,
}: MoodInputViewProps) {
