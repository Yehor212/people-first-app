...
import { getRankMedal, type LeaderboardEntry, type LeaderboardType } from '@/lib/leaderboard';
...
export function LeaderboardEntryRow({ entry, index, activeTab, t }: LeaderboardEntryRowProps) {
  const rankConfig = RANK_CONFIGS[entry.rank as 1 | 2 | 3] as typeof RANK_CONFIGS[1] | undefined;
    ...
    >
      ...
      <div className="text-end">
        <span className={cn(
          ...
          {getValue(entry, activeTab).toLocaleString()}
        </span>
