...
const MOODS: {
...
}[] = [
  {
    ...
    Icon: SmilePlus,
    label: "Great",
    color: "text-emerald-400 hover:bg-emerald-400/20",
  },
  {
    mood: "good",
    Icon: Smile,
    label: "Good",
    color: "text-teal-400 hover:bg-teal-400/20",
  },
  {
    mood: "okay",
    Icon: Meh,
    label: "Okay",
    color: "text-amber-400 hover:bg-amber-400/20",
  },
  {
    mood: "bad",
    Icon: Frown,
    label: "Bad",
    color: "text-orange-400 hover:bg-orange-400/20",
  },
  {
    mood: "terrible",
    Icon: Angry,
    label: "Terrible",
    color: "text-red-400 hover:bg-red-400/20",
  },
];
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="absolute top-2 end-2 p-1.5 rounded-lg text-white/60 hover:text-white/70 hover:bg-white/10 dark:hover:bg-white/10 motion-safe:transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        "hover:bg-white/5 dark:hover:bg-white/5 motion-safe:transition-colors"
                      )}
                    >
                      {t.cancel || "Cancel"}
                    </button>
