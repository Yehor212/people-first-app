...
export function FriendsPanel({
  ...
  return (
    <div
      ...
      className="fixed inset-0 lg:mx-auto lg:my-8 lg:max-w-2xl lg:rounded-2xl lg:shadow-2xl z-[60] bg-background/95 backdrop-blur-sm overflow-y-auto motion-safe:animate-fade-in"
    >
