...
export function WelcomeOverlay({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div
      ...
      tabIndex={-1}
      className="fixed inset-0 z-[80] flex items-center justify-center bg-black/60 backdrop-blur-sm motion-safe:animate-fade-in px-3 sm:px-4 lg:mx-auto lg:my-8 lg:max-w-2xl lg:rounded-2xl lg:shadow-2xl"
      role="dialog"
      aria-modal="true"
