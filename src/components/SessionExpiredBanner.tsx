...
export function SessionExpiredBanner({ onSignIn }: SessionExpiredBannerProps) {
  ...
  return (
    <div className="mb-3 animate-fade-in">
      <button
        onClick={onSignIn}
        className="w-full flex items-center gap-3 p-3.5 bg-amber-500/10 border border-amber-500/30 rounded-2xl text-left transition-colors hover:bg-amber-500/15 active:scale-[0.99]"
      >
