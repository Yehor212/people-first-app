...
function patchRemoteBackup(
  ...
  localBackup: BackupPayloadV4
): BackupPayloadV3 | BackupPayloadV4 {
  ...
  if (
    !remote ||
    !remoteData ||
    (remote.schemaVersion !== 3 && remote.schemaVersion !== 4)
  ) {
    throw new RequiredRemoteCommitError("stale");
  }
  ...
  return {
    ...(remote as unknown as BackupPayloadV3 | BackupPayloadV4),
    data: {
