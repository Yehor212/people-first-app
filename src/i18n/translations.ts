...
const baseTranslations: Partial<Record<Language, Translations>> = {
  ru: {
    ...
    habitTypeDailyDesc: 'Отмечайте раз в день',
    habitTypeMultipleDesc: 'Считайте количество за день',
    habitTypeContinuousDesc: 'Не прерывайте цепочку',
    habitTypeReduceDesc: 'Уменьшайте со временем',
    habitRestDay: 'Выходной',
    habitSwipeHint: 'Свайп влево для опций',
    habitNameRequired: 'Введите название',
    ...
    weatherCalm: 'Спокойно',
    weatherHappy: 'Солнечно',
    weatherFocused: 'Северное сияние',
    weatherAnxious: 'Туман',
    weatherSad: 'Дождливо',
    weatherAngry: 'Огненно',
    weatherTired: 'Пасмурно',
    weatherEnergized: 'Электрично',
    weatherNeutral: 'Переменная облачность',
    weatherRadiant: 'Сияние',
    weatherMelancholy: 'Ливень',
    weatherMessageCalm: 'Спокойное, умиротворённое состояние',
    weatherMessageHappy: 'Твоё настроение сияет!',
    weatherMessageFocused: 'В потоке — огни танцуют над головой',
    weatherMessageAnxious: 'Туманные мысли, но ясность придёт',
    weatherMessageSad: 'Немного дождливо, но это пройдёт',
    weatherMessageAngry: 'Огненная энергия — направь её мудро',
    weatherMessageTired: 'Тяжёлые облака — отдых тоже важен',
    weatherMessageEnergized: 'Искры летят — используй эту силу!',
    weatherMessageNeutral: 'Сбалансированный, нейтральный день',
    weatherMessageRadiant: 'Абсолютное сияние — дари тепло!',
    weatherMessageMelancholy: 'Глубокие воды — будь бережнее к себе',
    weatherMessageStormy: 'Грозы проходят со временем',
    moodCalendar: 'Календарь настроения',
    moodCalendarEmpty: 'Нет записей настроения за этот месяц',
    moodCalendarStreak: 'Серия',
    moodCalendarMostCommon: 'Чаще всего',
    moodCalendarBestDay: 'Лучший день',
    moodCalendarTapDay: 'Нажми на день для деталей',
    ...
    // Journal / Diary
    journalTitle: 'Личный дневник',
    journalSubtitle: 'Начните записывать мысли',
    journalEmpty: 'Дневник пуст',
    journalEmptyHint: 'Начните писать, чтобы сохранить свои мысли, чувства и воспоминания.',
    journalEmptyQuote: 'Ваши мысли достойны сохранения',
    journalNewEntry: 'Написать первую запись',
    journalEntries: 'записей',
    journalToday: 'Сегодня',
    journalYesterday: 'Вчера',
    journalThisWeek: 'На этой неделе',
    journalEarlier: 'Ранее',
    journalEntryTitle: 'Заголовок (необязательно)',
    journalEntryPlaceholder: 'О чём вы думаете?',
    journalSave: 'Сохранить',
    journalBack: 'Назад',
    journalNext: 'Далее',
    journalAdd: 'Добавить',
    journalDeleteEntry: 'Удалить запись?',
    journalDeleteConfirm: 'Это действие нельзя отменить.',
    journalStickerAdd: 'Добавить стикер',
    journalPhotoAdd: 'Добавить фото',
    journalRemaining: 'осталось',
    journalPhotoTake: 'Сделать фото',
    journalPhotoChoose: 'Из галереи',
    journalTagPlaceholder: 'Добавить тег...',
    journalSettings: 'Настройки дневника',
    journalLocked: 'Дневник заблокирован',
    journalUnlock: 'Разблокировать',
    journalPasswordSetup: 'Установить пароль дневника',
    journalPasswordEnter: 'Введите пароль',
    journalPasswordConfirm: 'Подтвердите пароль',
    journalPasswordHint: 'Этот пароль защищает только дневник. Восстановление невозможно — запомните его.',
    journalPasswordTooShort: 'Минимум 4 символа',
    journalPasswordMismatch: 'Пароли не совпадают',
    ...
    journalUndo: 'Отменить',
    journalEntryDeleted: 'Запись удалена',
    journalCompressing: 'Сжатие...',
    journalPhotoError: 'Не удалось добавить фото',
    journalDraftFound: 'Найден несохранённый черновик',
    journalRestore: 'Восстановить',
    journalDiscardTitle: 'Несохранённые изменения',
    journalDiscardMessage: 'У вас есть несохранённые изменения.',
    journalDiscard: 'Отменить',
    journalKeepWriting: 'Продолжить',
    journalSaveClose: 'Сохранить и закрыть',
    journalWords: 'слов',
    journalEntrySaved: 'Запись сохранена',
    journalWritingPrompts: 'Подсказки',
    journalPrompt1: 'Что заставило вас улыбнуться сегодня?',
    journalPrompt2: 'Что было сложным сегодня?',
    journalPrompt3: 'За что вы благодарны?',
    journalPrompt4: 'Опишите момент, который запомнился сегодня.',
    journalPrompt5: 'Чему вы научились сегодня?',
    journalPrompt6: 'Как вы себя чувствуете сейчас?',
    journalPrompt7: 'Что бы вы хотели запомнить о сегодняшнем дне?',
    journalPrompt8: 'Чего вы достигли?',
    journalPrompt9: 'Напишите о том, кто вас вдохновил.',
    journalPrompt10: 'Какие мысли перед сном?',
    ...
    journalAudioSaved: 'Аудио сохранено',
    journalAudioError: 'Не удалось сохранить аудио',
    journalVoiceNotSupported: 'Распознавание речи не поддерживается в этом браузере',
    journalAudioMaxReached: 'Максимум 3 записи',
    journalDictating: 'Слушаю...',
    journalDictateStop: 'Стоп',
    journalToolbarVoice: 'Голос',
    journalToolbarRecord: 'Запись',
    journalRecording: 'Запись',
    journalAudioMaxDuration: 'Макс. 5 минут',
    journalRecordingStop: 'Остановить запись',
    journalHabitsSection: 'Привычки',
    journalStatsTitle: 'Статистика дневника',
    journalStatsEmpty: 'Начните писать, чтобы увидеть статистику',
    journalStatsTotal: 'Всего записей',
    journalStatsTotalWords: 'Всего слов',
    journalStatsStreaks: 'Текущая серия',
    journalStatsDays: 'дн.',
    journalStatsLongestStreak: 'Лучшая серия',
    journalStatsThisMonth: 'В этом месяце',
    journalStatsAvgPerWeek: 'Сред./неделю',
    journalStatsMoodDist: 'Распределение настроения',
    journalStatsMoodTime: 'Настроение по времени',
    journalStatsFrequency: 'Частота записей',
    journalStatsMostActiveDay: 'Самый активный день',
    journalStatsTagCloud: 'Популярные теги',
    journalTemplates: 'Шаблоны',
    journalTemplateBlank: 'Пустая запись',
    journalTemplateBlankDesc: 'Начать с чистого листа',
    journalTemplateDailyReflection: 'Дневной итог',
    journalTemplateDailyReflectionDesc: '3 раздела',
    journalTemplateGratitude: 'Благодарность',
    journalTemplateGratitudeDesc: '3 раздела',
    journalTemplateGoalSetting: 'Постановка целей',
    journalTemplateGoalSettingDesc: '3 раздела',
    journalTemplateFreeWrite: 'Свободное письмо',
    journalTemplateFreeWriteDesc: '1 раздел',
    journalTemplateWeeklyReview: 'Обзор недели',
    journalTemplateWeeklyReviewDesc: '3 раздела',
    journalTemplateHighlight: 'Что было самым ярким за день?',
    journalTemplateChallenge: 'Что было сложным?',
    journalTemplateTomorrow: 'На чём хочешь сфокусироваться завтра?',
    journalTemplateGrateful1: 'Что меня порадовало...',
    journalTemplateGrateful2: 'Человек, которого я ценю...',
    journalTemplateGrateful3: 'Маленький момент, который заметил(а)...',
    journalTemplateCurrentGoal: 'К чему я стремлюсь?',
    journalTemplateProgress: 'Какого прогресса я достиг(ла)?',
    journalTemplateNextStep: 'Какой мой следующий шаг?',
    journalTemplateFreeWritePrompt: 'Просто начни писать... дай мыслям течь свободно.',
    journalTemplateWeekWins: 'Что прошло хорошо на этой неделе?',
    journalTemplateWeekLessons: 'Что я узнал(а)?',
    ...
    journalResetCheckEmail: 'Нажмите ссылку в письме, чтобы удалить пароль дневника. Страница обновится автоматически.',
    journalResetWaiting: 'Ожидание подтверждения...',
    journalResetSendLink: 'Отправить ссылку',
    journalPasswordChange: 'Сменить пароль',
    journalPasswordChangeSuccess: 'Пароль успешно изменён',
    journalPasswordRemoveConfirm: 'Вы уверены? Дневник будет доступен без пароля.',
    journalPasswordOldWrong: 'Неверный текущий пароль',
    journalPasswordOldEnter: 'Введите текущий пароль',
    journalPasswordNewEnter: 'Введите новый пароль',
    journalPasswordChangeConfirm: 'Сменить пароль',
    journalBiometricEnable: 'Биометрическая разблокировка',
    journalBiometricSubtitle: 'Разблокировка отпечатком или лицом',
    journalBiometricUnlock: 'Разблокировать биометрией',
    journalScreenshotBlock: 'Блокировка скриншотов',
    journalScreenshotBlockSubtitle: 'Запретить снимки экрана при открытом дневнике',
    journalDataSection: 'Данные',
    journalExport: 'Экспорт',
    journalImport: 'Импорт',
    journalImportSuccess: 'Импортировано',
    journalImportDuplicate: 'дубликатов пропущено',
    journalImportFailed: 'Ошибка импорта',
    journalExportFormat: 'Формат экспорта',
    journalExportJSON: 'JSON резервная копия',
    journalExportJSONDesc: 'Полная копия с фото и аудио',
    journalExportCSV: 'CSV',
    journalExportCSVDesc: 'Формат таблицы',
    journalExportPDF: 'PDF',
    journalExportPDFDesc: 'Для печати',
    journalExportText: 'Markdown',
    journalExportTextDesc: 'Текстовый формат',
    journalExportSuccess: 'Экспорт завершён',
    journalExportFailed: 'Ошибка экспорта',
  },
...
const hebrewOverrides: Partial<Translations> = {
  ...
  healthConnectAgeDesc: 'תכונות Health Connect דורשות גיל 13 ומעלה לשימוש אחראי בנתוני בריאות.',
  ...
  growth: 'צמיחה',
  stage: 'שלב',
  treeThirstyCanWater: '💧 העץ צמא...',
  treeThirstyNoTreats: '🥀 צמא... השלם פעילויות כדי להרוויח חטיפים!',
  treeStreakLegend: '🌟 {streak} ימים! העץ זוהר!',
  treeStreakGood: '✨ {streak} ימים! גדל חזק!',
  treeMaxStage: '🌳 עץ גדול ומרשים!',
  treeStage4: '🌲 עץ בוגר ויפה!',
  treeStage3: '🌿 צומח לשתיל חזק!',
  treeStage2: '🌱 נבט צעיר מושיט ידיים לאור!',
  treeStage1: '🌰 זרע קטן מלא פוטנציאל!',
  treeHappy: '💚 העץ פורח!',
  treeSeason: '{emoji} {season} יפה!',
  treeStageUp: '🎉 התפתח ל-{stage}!',
  treeMissedYou: 'העץ שלך התגעגע!',
  treeNeedsWater: 'העץ צריך מים!',
  waterDecayHint: 'מפלס המים יורד -2% בשעה',
  seasonTreeHint: 'העץ משתנה עם העונות!',
  ...
  // Health Connect
  healthConnect: 'Health Connect',
  healthConnectDescription: 'סנכרון עם Google Health Connect',
  healthConnectLoading: 'בודק Health Connect...',
  healthConnectNotAvailable: 'לא זמין במכשיר זה',
  healthConnectUpdateRequired: 'נא לעדכן את אפליקציית Health Connect',
  ...
  syncFocusSessionsHint: 'שמור מפגשי מיקוד כמיינדפולנס ב-Health Connect',
  openHealthConnect: 'פתח Health Connect',
  refresh: 'רענן',
  permissions: 'הרשאות',
