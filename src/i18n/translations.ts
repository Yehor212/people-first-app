...
const baseTranslations: Partial<Record<Language, Translations>> = {
  ru: {
    ...
    // Additional UI keys
    allDone: 'Готово!',
    authRequired: 'Войдите, чтобы восстановить из облака.',
    average: 'средний',
    calendarSelectMonth: 'Выберите месяц',
    cloudSyncError: 'Не удалось синхронизировать с облаком',
    code: 'Код',
    companionName: 'Имя компаньона',
    complete: 'Выполнить',
    copied: 'Скопировано',
    ...
    databaseRecoveryStartFreshDesc: 'Локальные данные сброшены.',
    duration: 'Длительность',
    editName: 'Изменить имя',
    expired: 'Истёк',
    exporting: 'Экспорт...',
    feedbackBug: 'Ошибка',
    feedbackFeature: 'Функция',
    feedbackInvalidEmail: 'Неверный формат email',
    feedbackOther: 'Другое',
    feedbackPlaceholder: 'Опишите ваш отзыв...',
    feedbackSent: 'Спасибо за отзыв!',
    friend: 'друг',
    habit: 'Привычка',
    habitNamePlaceholder: 'Введите название привычки...',
    imageSaved: 'Изображение сохранено в загрузки!',
    importing: 'Импорт...',
    ...
    moodUpdated: 'Настроение обновлено',
    noParticipantsYet: 'Поделитесь кодом челленджа, чтобы пригласить друзей!',
    offlineBannerDismiss: 'Закрыть',
    offlineBannerPending: 'изменений ожидают синхронизации',
    offlineBannerRetry: 'Повторить подключение',
    offlineBannerTitle: 'Вы офлайн',
    optional: 'необязательно',
    participants: 'Участники',
    participantsLocalOnly: 'Войдите, чтобы видеть других участников',
    perDay: 'в день',
    period: 'Период',
    play: 'Играть',
    preview: 'Предпросмотр',
    pwaUpdateAvailable: 'Доступно обновление',
    pwaUpdateButton: 'Обновить',
    pwaUpdateDescription: 'Новая версия готова. Обновите страницу.',
    recommendation: 'Для вас',
    reminders: 'Напоминания',
    remindersToggle: 'Панель напоминаний',
    ringRecommendationFocusHigh: 'Мастерство глубокой работы! Ваши сессии фокуса приносят плоды.',
    ringRecommendationFocusLow: 'Начните с 10 минут фокуса. У вас получится.',
    ringRecommendationFocusMid: 'Попробуйте 25-минутную сессию Помодоро для следующей задачи.',
    ringRecommendationHabitsHigh: 'Отличная стабильность! Ваши привычки набирают обороты.',
    ringRecommendationHabitsLow: 'Маленькие шаги важны. Одна привычка сегодня — серия завтра.',
    ringRecommendationHabitsMid: 'Вы делаете успехи. Начните с любимой привычки.',
    ringRecommendationMoodHigh: 'Вы в отличном настроении! Поделитесь позитивом с кем-нибудь.',
    ringRecommendationMoodLow: 'Будьте мягче к себе. Короткая прогулка или дыхательное упражнение помогут.',
    ringRecommendationMoodMid: 'Попробуйте 3-минутную практику благодарности для улучшения настроения.',
    scheduleEventType: 'Тип события',
    selectColor: 'Выберите цвет',
    selectCompanion: 'Выбрать',
    selectIcon: 'Выберите иконку',
    selectMood: 'Выберите настроение',
    send: 'Отправить',
    sending: 'Отправка...',
    settingsSaveFailed: 'Не удалось сохранить настройку',
    shareError: 'Не удалось поделиться. Попробуйте скачать.',
    shareGenerateError: 'Не удалось создать изображение. Попробуйте ещё раз.',
    sharing: 'Отправка...',
    showMoreRecommendations: 'Показать больше рекомендаций',
    startFocus: 'Начать фокус',
    storageWarningMessage: 'Данные могут не сохраниться. Отключите приватный режим или очистите хранилище.',
    storageWarningPrivateMode: 'Обнаружен приватный/инкогнито режим. Ваши данные не будут сохранены.',
    storageWarningTitle: 'Предупреждение о хранилище',
    suggestedGoals: 'Рекомендуемые',
    switchToDark: 'Тёмная тема',
    switchToLight: 'Светлая тема',
    syncPending: 'ожидание',
    toggleTheme: 'Сменить тему',
    treats: 'Угощения',
    trendsTimeRange: 'Временной диапазон',
    trophyIcon: 'Кубок',
    updateDescriptionVersion: 'Версия {version} доступна с улучшениями и исправлениями.',
    viewHabits: 'Просмотр привычек',
    viewProgress: 'Просмотр прогресса \u2192',
    weekHigh: 'Лучший',
    weekLow: 'Низкий',
    weeklyTrend: 'Недельный тренд',
    you: 'Вы',
    zenScoreTapToExpand: 'Нажмите для подробностей',
  },
...
const arabicOverrides: Partial<Translations> = {
  ...
  healthConnectAgeDesc: 'للوصول لـHealth Connect يجب أن يكون عمرك 13+',
  ...
  growth: 'النمو',
  stage: 'المرحلة',
  treeThirstyCanWater: 'شجرتك عطشى! اسقها',
  treeThirstyNoTreats: 'شجرتك عطشى لكن لا مكافآت',
  treeStreakLegend: 'شجرتك مزدهرة!',
  treeStreakGood: 'شجرتك تنمو جيداً!',
  treeMaxStage: 'شجرتك وصلت للمرحلة القصوى!',
  treeStage4: 'شجرتك ناضجة!',
  treeStage3: 'شجرتك تزهر!',
  treeStage2: 'شجرتك تكبر!',
  treeStage1: 'شجرتك تنبت!',
  treeHappy: 'شجرتك سعيدة!',
  treeSeason: 'موسم الشجرة',
  treeStageUp: 'شجرتك ترقت!',
  treeMissedYou: 'شجرتك افتقدتك!',
  treeNeedsWater: 'شجرتك تحتاج ماء',
  waterDecayHint: 'اسقِ يومياً للحفاظ على الصحة',
  seasonTreeHint: 'الشجرة تتغير حسب الموسم',
  ...
  // Health Connect
  healthConnect: 'Health Connect',
  healthConnectDescription: 'ربط مع Health Connect',
  healthConnectLoading: 'جاري التحميل...',
  healthConnectNotAvailable: 'غير متاح',
  healthConnectUpdateRequired: 'يحتاج تحديث',
  mindfulness: 'الوعي',
  sleep: 'النوم',
  steps: 'الخطوات',
  stepsLabel: 'خطوات',
  ...
  syncFocusSessionsHint: 'مزامنة مع Health Connect',
  openHealthConnect: 'فتح Health Connect',
  refresh: 'تحديث',
