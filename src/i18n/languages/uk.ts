...
export const uk: Translations = {
  ...
  habitSetupHint: "Перед збереженням перевірте ціль, одиницю виміру та нагадування для цього шаблону.",
  ...
  identityMapping: "Зв'язок з ідентичністю",
  identityMappingHint: "Пов'яжіть звичку з тим, ким ви стаєте",
  identityCluster: "Кластер",
  identityClusterPlaceholder: "напр., Усвідомлений Я",
  ...
  journalBurnAThought: "Спалити думку",
  ...
  navV2HabitsAddCue: "Коли • Де • Сигнал",
  navV2HabitsEmpty: "Посади перше зерно",
  navV2HabitsStartSmall: "Почни з 3 звичок — малі кроки перемагають",
  ...
  navV2HabitsIdentityToday: "Сьогодні ти будуєш:",
  navV2HabitsIdentityIntention: "Людину, яка тримає слово",
  navV2HabitsTwoMinuteRule: "Почни з 2-хвилинної версії",
  ...
  navV2HabitsOnboardingStep1: "Обери свою ідентичність",
  navV2HabitsOnboardingStep2: "Встанови сигнал",
  navV2HabitsOnboardingStep3: "Посади першу звичку",
  navV2HabitsCollapseGroup: "Згорнути {label}",
  navV2HabitsExpandGroup: "Розгорнути {label}",
  navV2HabitsBrowseLibrary: "Переглянути бібліотеку звичок",
  ...
  orbFirstRunStep1: "Провідай орб туди, де твій настрій",
