...
export const uk: Translations = {
  ...
  ...defineJournalRecoveryTranslations([
    "Цю функцію вимкнено в налаштуваннях ZenFlow.",
    "Ця функція з’явиться після трохи більшої активності в ZenFlow.",
    "ZenFlow перевіряє вашу нещодавню активність. Спробуйте ще раз за мить.",
    "ZenFlow не вдалося перевірити нещодавню активність на цьому пристрої. Нічого не змінено. Спробуйте ще раз.",
    ...
    "Кількість записів щоденника, які зараз не вдалося показати: {count}. Ваші збережені дані не видалено.",
    "Спробувати завантажити ще раз",
    ...
    "Продовжити зняття захисту щоденника",
    "Повторити онлайн-очищення",
    "Повторюємо...",
    ...
    "Щоденник ще прив’язується до цього акаунта. Залиште застосунок відкритим і не виходьте з акаунта, а потім спробуйте ще раз. Нічого не змінилося.",
    ...
    "Підтвердити акаунт",
    "Починаємо підтвердження...",
    "Не вдалося почати підтвердження акаунта. Нічого не змінилося. Перевірте з’єднання й спробуйте ще раз.",
    "Перевіряємо акаунт, якому належить цей щоденник...",
    "ZenFlow лише підтвердить той самий акаунт і не змінюватиме щоденник або пароль.",
    "Увійдіть в акаунт, якому належить цей щоденник, і почніть підтвердження знову. Нічого не змінилося.",
    "Для цього акаунта на цьому пристрої немає доступного способу входу. Відкрийте налаштування акаунта й спочатку підтвердьте спосіб входу.",
    "Ми надішлемо посилання для підтвердження на адресу акаунта, якому належить цей щоденник.",
    "Відкрийте посилання на цьому пристрої та поверніться до ZenFlow. Воно підтвердить акаунт, але не вимкне захист щоденника.",
    "Акаунт підтверджено. За потреби розблокуйте щоденник і ще раз спробуйте прибрати захист.",
    "Акаунт підтверджено",
    "За потреби розблокуйте щоденник і ще раз спробуйте прибрати захист. Саме підтвердження не змінило щоденник або пароль.",
    "Закрити й розблокувати щоденник",
    "Знову спробувати прибрати захист",
    "Ми надішлемо одноразовий код на номер цього акаунта. Саме підтвердження не змінить щоденник.",
    "Підтвердження телефоном",
    "Надіслати одноразовий код на номер",
    "Надіслати код",
    "Введіть код підтвердження",
    "Код підтвердження",
    "Введіть шестизначний код підтвердження.",
    "Підтвердити",
    "Виберіть спосіб входу, уже пов’язаний із цим акаунтом. Щоденник не зміниться, доки ви явно не повторите видалення захисту.",
    "Скористайтеся пов’язаним способом входу",
    "Підтвердити через {provider}",
