...
export const uk: Translations = {
  ...
  scheduleCompletedAt: "Завершено о",
  ...
  socialHubChallengesTab: "Виклики",
  ...
  challengeProgressComplete: "Виконано на {percent}%",
  ...
  challengeLookupUnavailable:
    "Не вдалося перевірити це змагання. Перевірте з’єднання й спробуйте ще раз.",
  challengeInviteOffline: "Немає з’єднання. Підключіться до інтернету й спробуйте знову.",
  challengeInviteNotFound: "Не вдалося знайти виклик із таким кодом.",
  challengeInviteExpired: "Цей виклик уже завершився.",
  challengeInviteSelf: "Це ваш власний виклик.",
  challengeInviteDuplicate: "Ви вже приєдналися до цього виклику.",
  challengeInviteSignedOut: "Увійдіть, щоб приєднуватися до викликів.",
  ...
  friendInviteInvalid: "Цей код друга недійсний. Перевірте його й спробуйте знову.",
  friendInviteSelf: "Це ваш власний код друга.",
  friendInviteDuplicate: "Цей друг уже є у вашому списку.",
  friendInviteOffline: "Немає з’єднання. Підключіться до інтернету й спробуйте знову.",
  friendInviteNotFound: "Не вдалося знайти такий код друга. Перевірте його й спробуйте знову.",
  friendInviteSignedOut: "Увійдіть, щоб додавати друзів.",
  friendInviteUnavailable: "Пошук друзів зараз недоступний. Спробуйте пізніше.",
  friendProfilePreparing: "Готуємо ваш код друга…",
  friendProfileUnavailable: "Зараз ваш код друга недоступний. Перевірте з’єднання й повторіть спробу.",
  ...
  connectedRecordsTitle: "Пов’язані записи",
  connectedRecordsDescription: "Дозвольте вибраним розділам ZenFlow оновлювати один одного.",
  connectedRecordsToggle: "Пов’язані записи",
  connectedRecordsToggleHint: "Нічого не пов’язується, доки ви не ввімкнете цю функцію.",
  connectedRecordsRulesTitle: "Виберіть точні зв’язки",
  connectedRecordsRulesDescription:
    "Ці правила змінюють лише названі нижче записи. Вони не вгадують текст чи почуття.",
  connectedRecordsRuleMoodJournal: "Нотатка про настрій → запис у щоденнику",
  connectedRecordsRuleMoodJournalHint:
    "Копіює лише вашу нотатку після збереження настрою.",
  connectedRecordsRuleJournalMood: "Вибраний настрій у щоденнику → запис настрою",
  connectedRecordsRuleJournalMoodHint:
    "Використовує лише настрій, який ви вибрали; текст щоденника не читається.",
  connectedRecordsRuleFocusHabit: "Завершений фокус → вибрана звичка",
  connectedRecordsRuleFocusHabitHint:
    "Оновлює вибрану звичку після завершеної фокус-сесії потрібної тривалості.",
  connectedRecordsRuleHabitPlanning: "Звичка → власний блок плану",
  connectedRecordsRuleHabitPlanningHint:
    "Позначає завершеним лише вибраний блок за цю дату після виконання звички.",
  connectedRecordsPlanningMappingsTitle: "Виділені блоки плану",
  connectedRecordsPlanningMappingsDescription:
    "Виберіть один із сьогоднішніх блоків-нагадувань для кожної звички, яку хочете пов’язати.",
  connectedRecordsPlanningHabitName: "Звичка",
  connectedRecordsPlanningBlockLabel: "Сьогоднішній виділений блок",
  connectedRecordsPlanningBlockNone: "Не пов’язано",
  connectedRecordsPlanningNoBlocks:
    "Додайте до звички ввімкнене нагадування, перш ніж пов’язувати блок плану.",
  connectedRecordsChoosePlanningBlockError:
    "Виберіть принаймні один виділений блок плану.",
  connectedRecordsFocusHabit: "Звичка для завершених фокус-сесій",
  connectedRecordsChooseHabit: "Виберіть звичку",
  connectedRecordsChooseHabitError: "Виберіть звичку для завершених фокус-сесій.",
  connectedRecordsChooseRuleError: "Виберіть принаймні один зв’язок.",
  connectedRecordsSaveRules: "Зберегти правила",
  connectedRecordsSaved: "Правила пов’язаних записів збережено.",
  connectedRecordsSaveError: "Не вдалося зберегти правила пов’язаних записів.",
  connectedRecordsHistory: "Переглянути історію та скасування",
  connectedRecordsServiceUnavailable: "Пов’язані записи зараз недоступні.",
  connectedRecordsRequiresProtection: "Спочатку розблокуйте та захистіть щоденник.",
  connectedRecordsRequiresOnline: "Підключіться до інтернету, щоб увімкнути цю функцію.",
  connectedRecordsLoadError: "Налаштування пов’язаних записів недоступні.",
  connectedRecordsDisableError: "Не вдалося вимкнути пов’язані записи.",
  connectedRecordsDisabled: "Пов’язані записи вимкнено.",
  connectedRecordsRevocationPending: "Вимкнення завершиться після відновлення з’єднання.",
  connectedRecordsEnableTitle: "Увімкнути пов’язані записи?",
  connectedRecordsEnableDescription: "Перевірте, що саме ZenFlow зможе записувати.",
  connectedRecordsEnableDetail:
    "Зміни виконуються лише за вибраними правилами. Вимкнення не видаляє наявну історію.",
  connectedRecordsEnableConfirm: "Увімкнути",
  automationHistoryTitle: "Історія пов’язаних записів",
  automationHistoryDescription: "Зашифрована історія автоматичних змін.",
  automationHistorySignInRequired: "Увійдіть, щоб переглянути історію пов’язаних записів.",
  automationHistoryError: "Історія пов’язаних записів зараз недоступна.",
  automationHistoryLoading: "Завантаження історії…",
  automationHistoryEmpty: "Історії пов’язаних записів ще немає.",
  automationHistoryActionError: "Не вдалося виконати цю зміну.",
  automationHistoryVaultRequired: "Розблокуйте захищений щоденник, щоб змінити історію.",
  automationHistoryStatusConnected: "Пов’язано",
  automationHistoryStatusReverted: "Скасовано",
  automationHistoryStatusPending: "Очікує",
  automationHistoryStatusNeedsReview: "Потребує перевірки",
  automationHistoryUndo: "Скасувати",
  automationHistoryUndoPending: "Скасування запитано",
  automationHistoryForget: "Забути",
  automationHistoryForgetTitle: "Забути цей елемент історії?",
  automationHistoryForgetDescription:
    "Це видалить можливість скасування, але збереже записи настрою, щоденника, фокусу та звичок.",
  automationHistoryForgetConfirm: "Забути",
  automationHistoryClearAll: "Очистити всю історію",
  automationHistoryClearTitle: "Очистити всю пов’язану історію?",
  automationHistoryClearDescription:
    "Це назавжди видалить усі скасування пов’язаних записів і вимкне цю функцію.",
  automationHistoryClearConfirm: "Очистити все",
  ...
  storageTimeoutCached:
    "ZenFlow показує останню доступну копію. Останні зміни можуть бути відсутні.",
  storageTimeoutTitle: "Частина збережених даних недоступна",
  storageTimeoutUnavailable:
    "ZenFlow поки не вдалося завантажити збережені дані. Закрийте й знову відкрийте застосунок, а потім повторіть спробу.",
