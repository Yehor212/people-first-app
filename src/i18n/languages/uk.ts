...
export const uk: Translations = {
  ...
  resetDataScope: "Це видалить локальні настрої, звички, фокус, подяки, журнал, черги та налаштування.",
  resetDataConfirmAction: "Скинути дані",
  data: "Дані",
  ...
  privacyPushNotifications: "Віддалені push-сповіщення",
  privacyPushNotificationsHint: "Зареєструвати цей пристрій для push-нагадувань акаунта. Локальні нагадування працюють без цього.",
  ...
  themeStyleTitle: "Стиль скла",
  themeStyleDescription: "Налаштуйте прозорість, зберігаючи текст читабельним.",
  ...
  themePreviewTitle: "Попередній перегляд",
  themePreviewDescription: "Перегляд показує картки, кнопки, фокус і вибрані стани до збереження.",
  ...
  themePaletteMorningHearth: "Мʼяке світло",
  themePaletteVelvetLibrary: "Глибоке скло",
  themePaletteBotanicalPulse: "Свіже скло",
  themePaletteQuietOled: "OLED-скло",
  themeAccentTeal: "Синій",
  ...
  settingsSoundComfortTitle: "Сенсорний комфорт",
  settingsSoundComfortDescription: "Профілі налаштовують атмосферу й короткі сигнали для Web, PWA, Android, iOS і Desktop.",
  settingsSoundProfileQuiet: "Тихо",
  settingsSoundProfileRich: "Насичено",
  settingsSoundProfileBalanced: "Збалансовано",
  settingsSoundProfileQuietDesc: "Без атмосфери, лише м’які сигнали завершення.",
  settingsSoundProfileRichDesc: "Повна атмосфера й сигнали там, де підтримується.",
  settingsSoundProfileBalancedDesc: "Легка атмосфера й важливі сигнали.",
  settingsSoundAmbientToggle: "Фоновий звук",
  settingsSoundAmbientToggleDesc: "Керує атмосферою входу, Orb і щоденника поза Hyperfocus.",
  settingsSoundCompletionCues: "Сигнали завершення",
  settingsSoundCompletionCuesDesc: "Дозволяє тихі підтвердження після значущих завершень.",
  settingsSoundReminderCues: "Передперегляд нагадувань",
  settingsSoundReminderCuesDesc: "Дозволяє звуки передперегляду нагадувань за вибором.",
  settingsSoundMilestoneCues: "Сигнали віх",
  settingsSoundMilestoneCuesDesc: "Дозволяє рідкісні сигнали прогресу без звуків звичайних натискань.",
  settingsSoundTextureTitle: "Текстури поза Hyperfocus",
  settingsSoundTextureDescription: "Оберіть текстури повітря, води й дощу для атмосфери входу, Orb і щоденника.",
  settingsSoundFeedbackTitle: "Відгук про комфорт звуку",
  settingsSoundFeedbackDescription: "Зберігає лише локальний вибір комфорту, платформу, стан без звуку та діапазон гучності.",
  settingsSoundAmbientOff: "Фоновий звук вимкнено в Сенсорному комфорті.",
  ...
  settingsSoundCrossPlatformTitle: "Доступність звуку",
  settingsSoundCrossPlatformNote: "Ті самі звукові налаштування діють у Web, PWA, Android, iOS і Desktop там, де це дозволяє платформа.",
  ...
  dopamineSoundsDesc: "Локальні звуки підтвердження та звуковий відгук",
  ...
  feedbackPrivacyNotice:
    "Відгук може містити ваше повідомлення, необов'язковий email, версію додатка, платформу, розмір екрана, мову та дані браузера. Не використовуйте це для термінової безпеки чи медичної допомоги.",
  ...
  notificationSystemSettingsDescription: "Пристрій або браузер можуть вимкнути чи приглушити нагадування ZenFlow. Звуки застосунку лишаються локальними, м’якими й керованими вами.",
  notificationSystemSettingsAndroidDescription: "Категорії сповіщень Android остаточно керують звуком, вібрацією та видимістю кожного каналу.",
  notificationSystemSettingsIosDescription: "Налаштування iOS і режими Focus остаточно керують звуком сповіщень, доставкою та стилем.",
  notificationSystemSettingsWebDescription: "Налаштування браузера й ОС можуть вимкнути або приглушити нагадування. Звуки застосунку лишаються локальними й запускаються дотиком.",
  notificationSystemSettingsDesktopDescription: "Налаштування браузера й ОС на desktop остаточно керують доставкою та звуком нагадувань.",
  ...
  journalLockHint: "Цей пароль шифрує щоденник на цьому пристрої. ZenFlow не може показати його; підтверджений email може зняти захист у підтримуваних сценаріях входу.",
  ...
  journalResetCodeSentHint: "Перейдіть за посиланням у листі, щоб прибрати захист щоденника.",
  ...
  journalResetNoAccount: "Увійдіть у розділі акаунта в Налаштуваннях, щоб зняти цей захист через email. Нічого не змінилося; записи щоденника залишаються захищеними.",
  ...
  journalResetCheckEmail:
    "Натисніть посилання в листі, щоб прибрати захист щоденника. Сторінка оновиться автоматично.",
