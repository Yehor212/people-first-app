...
export const uk: Translations = {
  ...
  importMode: "Як імпортувати",
  importMerge: "Додати до поточних даних",
  importReplace: "Замінити поточні дані",
  ...
  importConfirmMessage: "Імпортувати дані з цієї резервної копії?",
  syncing: "Оновлення...",
  signingIn: "Вхід...",
  signingOut: "Вихід...",
  deleting: "Видалення...",
  ...
  settingsImportReplaceTooltip:
    "Буде замінено поточні дані про настрій, звички, сеанси фокуса, подяки та налаштування, що входять до резервної копії. Частини щоденника замінюються лише тоді, коли вони є в резервній копії. Налаштування захисту цього пристрою не змінюються.",
  ...
  settingsSoundDescription: "Оберіть фонові звуки, звуки дій і гучність.",
  settingsSoundSummaryOn: "Звук увімкнено",
  settingsSoundSummaryOff: "Вимкнено",
  settingsSoundMaster: "Звук застосунку",
  settingsSoundMasterDesc: "Відтворювати звуки в ZenFlow.",
  ...
  settingsSoundAmbienceNote:
    "Слухайте тихий дощ, поки пишете в щоденнику. Звук починається лише після натискання кнопки відтворення.",
  settingsSoundTextureAir: "Повітря",
  settingsSoundTextureWater: "Вода",
  settingsSoundTextureRain: "Дощ",
  settingsSoundComfortTitle: "Стиль звучання",
  settingsSoundComfortDescription:
    "Оберіть стиль звучання, а потім налаштуйте окремі звуки нижче.",
  settingsSoundProfileQuiet: "Тихо",
  settingsSoundProfileBalanced: "Усі звуки",
  settingsSoundProfileQuietDesc: "Без фонових звуків; лише тихі звуки дій.",
  settingsSoundProfileBalancedDesc:
    "Відтворювати фонові звуки, звуки дій, сповіщень і досягнень.",
  settingsSoundAmbientToggle: "Фоновий звук",
  settingsSoundAmbientToggleDesc:
    "Відтворювати фонові звуки в ZenFlow, крім сеансів фокуса.",
  settingsSoundCompletionCues: "Звуки дій",
  settingsSoundCompletionCuesDesc: "Відтворювати тихий звук після завершення дії.",
  settingsSoundReminderCues: "Звуки сповіщень у ZenFlow",
  settingsSoundReminderCuesDesc:
    "Відтворювати звуки таймера та передперегляду нагадувань у ZenFlow. Це не змінює звук сповіщень телефона.",
  settingsSoundMilestoneCues: "Звуки досягнень",
  settingsSoundMilestoneCuesDesc:
    "Відтворювати звук для рідкісних серій і важливих досягнень.",
  settingsSoundTextureTitle: "Фонові звуки",
  settingsSoundTextureDescription:
    "Оберіть, які фонові звуки може відтворювати ZenFlow.",
  settingsSoundAmbientOff: "Фонові звуки вимкнено.",
