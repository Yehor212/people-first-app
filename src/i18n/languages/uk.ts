...
export const uk: Translations = {
  ...
  settingsSoundCrossPlatformNote: "Спільний звуковий маніфест охоплює Web, PWA, Android, iOS і Desktop; перед релізом перевіряються пакети.",
  ...
  journalLoadFailedHint: "Ваші записи не очищено. Спробуйте завантажити їх ще раз.",
  journalLoadFailed: "Не вдалося завантажити щоденник",
