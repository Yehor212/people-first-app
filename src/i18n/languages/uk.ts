...
export const uk: Translations = {
  ...
  themeStyleDescription: "Оберіть підготовлений вигляд, який лишається читабельним.",
  ...
  themePaletteMorningHearth: "Ранкове тепло",
  themePaletteVelvetLibrary: "Оксамитова бібліотека",
  themePaletteBotanicalPulse: "Ботанічний пульс",
  themePaletteQuietOled: "Тихий OLED",
  themeAccentTeal: "Бірюзовий",
  themeAccentClay: "Глина",
  themeAccentPlum: "Слива",
  themeAccentMoss: "Мох",
