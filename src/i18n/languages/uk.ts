...
export const uk: Translations = {
  ...
  scheduleDayHasEvents: "Є заплановані події",
  googleCalendarEventsLoading: "Завантажуємо події Google Календаря…",
  googleCalendarEventsUnavailable: "Події Google Календаря зараз недоступні.",
  ...
  privacyAds: "Банер у списку звичок",
  privacyAdsHint:
    "Після ввімкнення невеликий банер з’являється під списком звичок. Він не показується під час перевірки настрою, у щоденнику, фокусі та меню. За потреби Google може попросити обрати налаштування конфіденційності.",
  adAgeCheckTitle: "Перевірте свій вік",
  adAgeCheckDescription: "Введіть дату народження, перш ніж увімкнути банер.",
  adAgeBirthDate: "Дата народження",
  adAgeBirthDateHint:
    "Вона потрібна лише зараз, щоб визначити, чи доступний банер. ZenFlow не зберігає цю дату.",
  ...
  adAgeReviewHint:
    "Якщо дані змінилися, введіть дату народження ще раз. ZenFlow перевірить її, не зберігаючи.",
  ...
  notificationPermissionTitle: "Дозволити нагадування?",
  notificationPermissionDescription:
    "ZenFlow може надсилати нагадування про настрій, фокус і звички, які ви вмикаєте.",
  notificationFeature1Title: "Нагадування про настрій",
  notificationFeature1Desc: "У вибрані вами дні та час",
  notificationFeature2Title: "Нагадування про звички",
  notificationFeature2Desc: "У збережені для кожної звички дні та час",
  notificationFeature3Title: "Таймер фокусу",
  notificationFeature3Desc: "Коли завершиться фокус-сесія з таймером",
  notificationAllow: "Дозволити нагадування",
  notificationDeny: "Не зараз",
  ...
  hyperfocusToneLabel: "Тембр",
  hyperfocusToneHelp: "Зріз високих частот; висота тону та швидкість не змінюються.",
  hyperfocusToneSofter: "М’якше",
  hyperfocusToneFullSpectrum: "Повний спектр",
  hyperfocusToneUnavailable: "Налаштування тембру недоступне на цьому пристрої.",
  hyperfocusSoundLevelSoft: "М’який",
  hyperfocusSoundLevelDeep: "Глибокий",
  hyperfocusSoundLevelIntense: "Інтенсивний",
  ...
  journalEntriesUnavailableCount:
    "Тимчасово недоступні записи щоденника: {count}. Решта записів відображається.",
  journalEntriesUnavailableCountZero: "Тимчасово недоступні {count} записів щоденника. Решта записів відображається.",
  journalEntriesUnavailableCountOne: "Тимчасово недоступний {count} запис щоденника. Решта записів відображається.",
  journalEntriesUnavailableCountTwo: "Тимчасово недоступні {count} записи щоденника. Решта записів відображається.",
  journalEntriesUnavailableCountFew: "Тимчасово недоступні {count} записи щоденника. Решта записів відображається.",
  journalEntriesUnavailableCountMany: "Тимчасово недоступні {count} записів щоденника. Решта записів відображається.",
  journalEntriesUnavailableCountOther: "Тимчасово недоступна така кількість записів щоденника: {count}. Решта записів відображається.",
  journalEntriesUnavailableAll:
    "Зараз не вдалося показати жодного запису щоденника. Ваші збережені дані не видалено.",
  journalEntriesUnavailableAllCountZero: "Зараз не вдалося показати {count} записів щоденника. Ваші збережені дані не видалено.",
  journalEntriesUnavailableAllCountOne: "Зараз не вдалося показати {count} запис щоденника. Ваші збережені дані не видалено.",
  journalEntriesUnavailableAllCountTwo: "Зараз не вдалося показати {count} записи щоденника. Ваші збережені дані не видалено.",
  journalEntriesUnavailableAllCountFew: "Зараз не вдалося показати {count} записи щоденника. Ваші збережені дані не видалено.",
  journalEntriesUnavailableAllCountMany: "Зараз не вдалося показати {count} записів щоденника. Ваші збережені дані не видалено.",
  journalEntriesUnavailableAllCountOther: "Зараз не вдалося показати таку кількість записів щоденника: {count}. Ваші збережені дані не видалено.",
  journalEntriesUnavailableRetry: "Спробувати завантажити ще раз",
  ...
  journalPrivateModeSaveError:
    "ZenFlow не вдалося зберегти це налаштування приватності. На цьому екрані щоденник залишається прихованим; не закривайте застосунок і спробуйте ще раз.",
  ...
  journalProtectionPasswordSyncPending:
    "Новий пароль щоденника вже працює на цьому пристрої. ZenFlow ще оновлює зашифрований ключ онлайн — залиште застосунок відкритим і під’єднайтеся до інтернету.",
  ...
  journalProtectionRemovalPreflightPending:
    "Захист щоденника ще ввімкнено. ZenFlow зупинився до зміни записів. Розблокуйте щоденник, залишайтеся онлайн і продовжте зняття захисту.",
  journalPasswordRemovalResume: "Продовжити зняття захисту щоденника",
  journalProtectionRemovalRetry: "Повторити онлайн-очищення",
  journalProtectionRemovalRetryPending: "Повторюємо...",
  ...
  journalLockRemoveFailed:
    "Спершу розблокуйте щоденник, а потім спробуйте прибрати захист ще раз. Нічого не змінилося.",
  ...
  journalLockRemovePartial:
    "На цьому пристрої захист щоденника вимкнено, але додаткове очищення ще триває. Залиште застосунок відкритим, не виходьте з акаунта й повторіть спробу після підключення до інтернету.",
  journalLockRemoveActivationPending:
    "Спершу завершіть налаштування захисту щоденника, а потім спробуйте ще раз. Нічого не змінилося.",
  journalLockRemoveRemovalPending:
    "Попереднє вимкнення захисту ще завершується. Не виходьте з цього акаунта й повторіть спробу трохи пізніше.",
  journalLockRemoveRevisionMismatch:
    "Щоденник змінився під час перевірки. Перезавантажте його, розблокуйте й спробуйте ще раз. Нічого не змінилося.",
  journalLockRemoveContentUnavailable:
    "Не вдалося відкрити частину захищених даних щоденника. Під’єднайтеся до інтернету, розблокуйте щоденник і спробуйте ще раз. Нічого не видалено.",
  journalLockRemoveOwnerChanged:
    "Акаунт змінився. Поверніться до акаунта, якому належить цей щоденник, і спробуйте ще раз. Нічого не змінилося.",
  journalLockRemoveStorageFailed:
    "Цей пристрій не зміг прочитати весь щоденник. Залиште застосунок відкритим, перезавантажте й спробуйте ще раз. Нічого не змінилося.",
  journalLockRemovePartialBiometric:
    "На цьому пристрої захист щоденника вимкнено. Очищення біометричного розблокування ще триває. Залиште застосунок відкритим і повторіть спробу.",
  journalLockRemovePartialCloud:
    "На цьому пристрої захист щоденника вимкнено. Зміна для інших ваших пристроїв ще не завершена. Не виходьте з акаунта й повторіть спробу після підключення до інтернету.",
  ...
  backgroundMusicTitle: "Вечірня музика",
  backgroundMusicStateOn: "Увімкнено",
  backgroundMusicStateOff: "Вимкнено",
  backgroundMusicStateLoading: "Завантаження",
  backgroundMusicStateBlocked: "Натисніть, щоб відновити",
  backgroundMusicStateUnavailable: "Недоступно",
  backgroundMusicPlayAction: "Увімкнути вечірню музику",
  backgroundMusicPauseAction: "Вимкнути вечірню музику",
  backgroundMusicPreviousAction: "Попередня мелодія",
  backgroundMusicNextAction: "Наступна мелодія",
  backgroundMusicStatePaused: "Призупинено",
  ...
  planningActionAddEvent: "Відкрити розклад, щоб додати подію",
  planningActionStartFocus: "Відкрити таймер фокусу",
  ...
  navV2HabitsActionsFor: "Дії для «{habit}»",
  ...
  featureUnavailableProgress:
    "ZenFlow не вдалося перевірити збережені записи щоденника на цьому пристрої. Перезавантажте застосунок і спробуйте ще раз. Нічого не видалено.",
  featureUnavailableDisabled:
    "Цю функцію вимкнено для цього профілю. Увімкніть її в налаштуваннях функцій і спробуйте ще раз.",
  featureUnavailableUnlock:
    "Ця функція ще недоступна для цього профілю. Ваші наявні дані не змінено.",
  featureUnavailableGeneric:
    "Ця функція тимчасово недоступна. Закрийте це повідомлення та спробуйте пізніше.",
};
