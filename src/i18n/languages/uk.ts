...
export const uk: Translations = {
  ...
  syncDeviceSessionsFootnote: "Це присутність синхронізації, не цифровий відбиток браузера і не вміст щоденника.",
  syncDeviceCurrent: "Поточний пристрій",
  syncDeviceRevoked: "Відкликано",
  syncDeviceLastSeen: "Востаннє",
  syncRevokeDevice: "Відкликати",
  syncRevoking: "Відкликаємо",
