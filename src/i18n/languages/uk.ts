...
export const uk: Translations = {
  ...
  whatsNew: {
    ...
    version: 'Версія',
    gotIt: 'Зрозуміло!',
    valenceOrb: { title: 'Новий дизайн Стану Душі', description: 'Красиві органічні форми, що змінюються з вашим настроєм — від гострих зірок до м\'яких квітів.' },
    visualPolish172: { title: 'Візуальна полірування', description: 'Преміум-анімації, GPU-оптимізований рендеринг та плавніші переходи.' },
    bugFixes172: { title: 'Виправлення помилок', description: 'Виправлено помилки синхронізації, кешу та покращено загальну стабільність.' },
