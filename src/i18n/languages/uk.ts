...
export const uk: Translations = {
  ...
  journalResetNoAccount: "Увійдіть в акаунт у Налаштуваннях, щоб використовувати зняття захисту через email",
  journalResetEncryptedUnavailable: "Цей щоденник зашифрований вашим паролем. Підтвердження email не може зняти цей захист, доки зашифрований вміст заблокований. Розблокуйте щоденник паролем, щоб зняти захист.",
