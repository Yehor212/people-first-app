...
export const uk: Translations = {
  ...
  settingsSoundComfortDescription: "Профілі налаштовують фоновий звук і короткі сигнали на підтримуваних пристроях.",
  ...
  settingsSoundFeedbackTitle: "Як відчувався цей звук?",
  settingsSoundFeedbackDescription: "Зберігає лише ваш вибір комфорту, тип пристрою, стан без звуку та діапазон гучності.",
  settingsSoundAmbientOff: "Фоновий звук вимкнено в комфорті звуку.",
