...
export const fr: Translations = {
  ...
  navV2Account: "Compte",
  navV2OrbPlaceholder: "Page Orbe — la phase 3-B connectera HomeTab ici.",
  ...
  navV2SettingsPlaceholder: "Page Paramètres — la phase 3-E connectera SettingsTab.",
  ...
  navV2HabitsAddCue: "Quand • Où • Signal",
  navV2HabitsEmpty: "Plante ta première graine",
  navV2HabitsStartSmall: "Commence par 3 habitudes — les petits pas gagnent",
  ...
  navV2HabitsIdentityToday: "Aujourd'hui tu construis :",
  navV2HabitsIdentityIntention: "Quelqu'un qui tient parole",
  navV2HabitsTwoMinuteRule: "Commence avec la version de 2 minutes",
  ...
  navV2HabitsOnboardingStep1: "Choisis ton identité",
  navV2HabitsOnboardingStep2: "Définis ton signal",
  navV2HabitsOnboardingStep3: "Plante ta première habitude",
  navV2HabitsCollapseGroup: "Réduire {label}",
  navV2HabitsExpandGroup: "Développer {label}",
  navV2HabitsBrowseLibrary: "Parcourir la bibliothèque d'habitudes",
  ...
  navV2HabitsQuickPick: "Choix rapide",
  ...
  orbFirstRunStep1: "Glisse l'orbe selon ton ressenti",
