...
export const fr: Translations = {
  ...
  identityMapping: "Habitude fondée sur l'identité",
  identityMappingHint: "Chaque pointage marque un pas vers la personne que vous devenez.",
  identityCluster: "Domaine d'identité",
  identityClusterPlaceholder: "ex., Corps en santé",
  identityVerb: "Je deviens",
  identityVerbPlaceholder: "ex., quelqu'un qui prend soin de son corps",
  identityIcon: "Symbole d'identité",
  identityDefaultVerb: "la personne que je deviens",
  identityVotePreview:
    "Après l'enregistrement, la carte montre cette identité; chaque réussite ajoute un vote pour elle.",
