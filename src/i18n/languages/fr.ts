...
export const fr: Translations = {
  ...
  syncDeviceSessionsFootnote: "Il s'agit d'une présence de synchronisation, pas d'une empreinte navigateur ni du contenu du journal.",
  syncDeviceCurrent: "Appareil actuel",
  syncDeviceRevoked: "Révoqué",
  syncDeviceLastSeen: "Vu pour la dernière fois",
  syncRevokeDevice: "Révoquer",
  syncRevoking: "Révocation",
