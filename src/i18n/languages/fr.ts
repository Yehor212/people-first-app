...
export const fr: Translations = {
  ...
  settingsSoundMapAuth: "Respiration mesurée à la connexion",
  ...
  settingsSoundMapFeedback: "Carillons de fin et de rappel",
  settingsSoundCrossPlatformTitle: "Préparation multiplateforme",
  settingsSoundCrossPlatformNote: "Prêt pour Web, PWA, Android, iOS et Desktop.",
  ...
  settingsSoundActionMapMilestones: "Réussites et séries",
  ...
  authMeasuredBreathLabel: "Respiration mesurée",
  authMeasuredBreathPlay: "Lire la respiration mesurée",
  authMeasuredBreathPause: "Mettre en pause la respiration mesurée",
  ...
  diaryStartFirstEntry: "Commence ta première entrée cette semaine",
  ...
  navV2Account: "Compte",
  navV2OrbPlaceholder: "Page Humeur — la phase 3-B connectera HomeTab ici.",
  navV2HabitsPlaceholder: "Page Habitudes — la phase 3-C connectera GardenTab + HabitHubTab.",
  navV2DiaryPlaceholder: "Page Journal — la phase 3-D connectera JournalModule.",
  ...
  navV2SettingsPlaceholder:
    "Vos réglages personnels sont en préparation ici. Les thèmes, rappels et options de confidentialité restent pour l’instant dans les paramètres classiques.",
  v2PortalEyebrow: "Aperçu V2",
  v2PortalTitle: "Entre dans le nouvel espace rituel",
  v2PortalBody:
    "Teste le flux V2 pensé pour mobile pendant que ZenFlow classique reste ta base sûre.",
  v2PortalStatus: "Mode aperçu, mêmes données",
  v2PortalCta: "Ouvrir V2",
  v2PortalOrb: "Orbe d’humeur",
  v2PortalHabits: "Habitudes",
  v2PortalDiary: "Journal",
  v2PortalAria: "Ouvrir l’aperçu ZenFlow V2",
  classicPortalEyebrow: "Base stable",
  classicPortalTitle: "Retour à ZenFlow classique",
  classicPortalBody: "Reviens à l’accueil actuel pendant que V2 reste disponible en aperçu.",
  classicPortalCta: "ZenFlow classique",
  classicPortalAria: "Revenir à ZenFlow classique",
  ...
  orbAmbienceLabel: "Ambiance de l'orbe",
  orbAmbiencePlay: "Lire l'ambiance de l'orbe",
  orbAmbiencePause: "Mettre en pause l'ambiance de l'orbe",
  diaryAmbienceLabel: "Ambiance du journal",
  diaryAmbiencePlay: "Lire l'ambiance du journal",
  diaryAmbiencePause: "Mettre en pause l'ambiance du journal",
  // Phase 3-A.4b
