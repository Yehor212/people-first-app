...
export const en: Translations = {
  ...
  smartRemindersNotEnoughData:
    "Keep using the app to unlock personalized reminder suggestions based on your patterns.",
  ...
  journalLoadFailedHint: "Your entries were not cleared. Try loading them again.",
  journalLoadFailed: "Diary could not load",
