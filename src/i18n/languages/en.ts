...
export const en: Translations = {
  ...
  visualTimeAwareness: "Visual time awareness",
  ...
  pauseTimer: "Pause",
  resetTimer: "Reset",
  adhdTimeManagement: "Flexible time planning",
  ...
  reminderFocusBody: "A 25-minute focus block is available when you want it.",
  ...
  errorBoundarySafeTitle: "Your data is safe",
  errorBoundarySafeBody:
    "Recovery mode paused only this screen. Your recent error was saved on this device.",
  ...
  // Database recovery
  databaseRecoveryTitle: "Data on this device was reset",
  databaseRecoveryDesc:
    "Storage on this device was cleared (possibly from clearing browser data). We will try to restore your data from your online backup.",
  databaseRecoveryRestore: "Restore from online backup",
  ...
  offlineBannerPending: "changes waiting to save online",
  ...
  journalFavoritesEmptyHint: "Add a favorite tag to an entry to keep it here.",
  journalToday: "Today",
  ...
  journalAiIndexing: "Building AI search index...",
  ...
  journalPhotoInvalidType: "Unsupported file type. Please use JPEG, PNG, WebP, or HEIC.",
  ...
  journalAudioPermissionDenied: "Microphone permission is needed to record audio.",
  ...
  journalReleaseTraceCountZero: "{count} thoughts released",
  journalReleaseTraceCountOne: "{count} thought released",
  journalReleaseTraceCountTwo: "{count} thoughts released",
  journalReleaseTraceCountFew: "{count} thoughts released",
  journalReleaseTraceCountMany: "{count} thoughts released",
  journalReleaseTraceCountOther: "{count} thoughts released",
  ...
  orbFirstRunStep2: "Choose a scope (moment, day, or time)",
