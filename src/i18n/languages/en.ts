...
export const en: Translations = {
  ...
  resetDataScope: "This removes local moods, habits, focus, gratitude, journal data, queues, and settings.",
  ...
  privacyDescription: "No hidden tracking. Signed-in data syncs only when account sync is on.",
  ...
  privacyAdsHint: "Optional videos only. The ad SDK stays off until this is enabled.",
  privacyPushNotifications: "Remote push notifications",
  privacyPushNotificationsHint: "Register this device for account-based push reminders. Local reminders work without this.",
  ...
  settingsCloudSyncDescription:
    "Signed-in data stays synced across devices. Local changes wait safely when connection is weak.",
  ...
  syncDeviceSessionsDescription: "See where your account is syncing without exposing private data.",
  syncDeviceSessionsActive: "Active devices",
  syncDeviceSessionsError: "Device sync status is temporarily unavailable.",
  syncDeviceSessionsEmpty: "Sign in to see synced devices.",
  syncDeviceSessionsFootnote: "Marking a device inactive hides it from sync presence; it does not sign that device out.",
  ...
  syncRetryHint: "Some local actions need another sync attempt.",
  ...
  syncActionCloudApplied: "Cloud changes applied",
  syncActionUpToDate: "Already up to date",
  syncActionGapRecovered: "Sync gap recovered",
  syncActionAnotherTab: "Another tab is syncing",
  syncActionSignIn: "Sign in to sync",
  syncActionWaitingConnection: "Waiting for connection",
  syncActionNeedsAttention: "Sync needs attention",
  syncActionUpdated: "Sync updated",
  ...
  settingsSoundCrossPlatformNote: "The same sound choices apply on web, PWA, Android, iOS, and desktop where the platform allows them.",
  ...
  widgetInfoDesc:
    "Widget data syncs whenever you update habits, complete focus sessions, or earn new badges.",
  ...
  widgetWebWarningDesc:
    "Widgets only work on mobile devices (iOS and Android). Install the mobile app to use widgets.",
  ...
  dopamineSoundsDesc: "Local confirmation sounds and audio feedback",
  ...
  syncStatusPending: "Changes pending",
  ...
  tutorialWelcomeDesc:
    "An app designed to help you stay focused, build healthy habits, and feel better every day.",
  tutorialBrainTitle: "Built for your brain",
  tutorialBrainSubtitle: "Whether you have ADHD or just struggle with focus",
  tutorialBrainDesc:
    "ZenFlow uses science-backed techniques to help you manage attention, time, and energy. No diagnosis needed – if you struggle with focus, this app is for you.",
  ...
  tutorialMoodDesc:
    "Quick daily check-ins help you notice what affects your energy and focus. Over time, you'll understand yourself better.",
  tutorialFocusTitle: "Deep focus mode",
  tutorialFocusSubtitle: "Block distractions, get things done",
  tutorialFocusDesc:
    "Use the Pomodoro technique with calming ambient sounds. Perfect for work, study, or creative projects.",
  ...
  tutorialDayClockDesc:
    "See your day as a circle with morning, afternoon, and evening zones. Watch your energy grow as you complete activities!",
  ...
  tutorialMoodThemeDesc:
    "When you feel great, the app celebrates with vibrant colors. When you feel down, it becomes calm and supportive.",
  ...
  tutorialReadyDesc:
    "Start small – just check in with how you're feeling today. Every step counts!",
  tutorialStart: "Let's Go!",
  goToSlide: "Go to slide",
  tutorialJournalTitle: "Diary",
  tutorialJournalSubtitle: "Your private space to reflect",
  tutorialJournalDesc:
    "Write about your day, capture thoughts, and track your journey. Your diary is always private and secure.",
  ...
  onboardingfocusTimerDescription:
    "Use the Pomodoro timer for deep concentration. Set 25 minutes, focus on one task, then take a break. Perfect for ADHD brains!",
  ...
  onboardingquestsDescription:
    "Daily and weekly quests add variety to your routine. Complete them for bonus rewards!",
  ...
  onboardingtasksDescription:
    "Task Momentum helps prioritize tasks specifically for ADHD. The system recommends what to do next based on urgency and your energy.",
  ...
  notificationSystemSettingsDescription: "Your device or browser can still mute or quiet ZenFlow reminders. App sounds stay local, gentle, and user-controlled.",
  notificationSystemSettingsAndroidDescription: "Android notification categories keep final control over sound, vibration, and visibility for each channel.",
  notificationSystemSettingsIosDescription: "iOS Settings and Focus modes keep final control over alert sound, delivery, and notification style.",
  ...
  notificationSystemSettingsDesktopDescription: "Desktop browser and OS notification settings keep final control over reminder delivery and sound.",
  ...
  authPrivacyNote:
    "Your data is stored locally and optionally synced to the cloud. We respect your privacy.",
  ...
  databaseRecoveryDesc:
    "Your local storage was cleared (possibly from clearing browser data). We will try to restore your data from the cloud.",
  ...
  journalResetCodeSentHint: "Click the link in your email to remove the diary lock.",
  ...
  ariaDailyRewards: "Daily rewards",
