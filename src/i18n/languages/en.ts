...
export const en: Translations = {
  ...
  settingsSoundMapAuth: "Sign-in measured breath",
  settingsSoundMapOrb: "Orb ambience",
  settingsSoundMapDiary: "Diary ambience",
  settingsSoundMapFocus: "Focus ambient library",
  settingsSoundMapFeedback: "Completion and reminder chimes",
  settingsSoundCrossPlatformTitle: "Cross-platform readiness",
  settingsSoundCrossPlatformNote: "Ready on Web, PWA, Android, iOS, and Desktop.",
  ...
  diaryStartFirstEntry: "Start your first entry this week",
  ...
  classicPortalBody: "Return to the current home while V2 stays available as a preview.",
