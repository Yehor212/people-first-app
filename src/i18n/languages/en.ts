...
export const en: Translations = {
  ...
  socialHubChallengesTab: "Challenges",
  ...
  challengeProgressComplete: "{percent}% complete",
  daysLeft: "days left",
  ...
  challengeInviteOffline: "You’re offline. Reconnect and try again.",
  challengeInviteNotFound: "We couldn’t find a challenge with that code.",
  ...
  friendInviteInvalid: "That friend code is not valid. Check it and try again.",
  friendInviteSelf: "That is your own friend code.",
  friendInviteDuplicate: "This friend is already in your list.",
  friendInviteOffline: "You’re offline. Reconnect and try again.",
  friendInviteNotFound: "We couldn’t find that friend code. Check it and try again.",
  friendInviteSignedOut: "Sign in to add friends.",
  friendInviteUnavailable: "Friend lookup is unavailable right now. Try again later.",
  friendProfilePreparing: "Preparing your friend code…",
  friendProfileUnavailable: "Your friend code is unavailable right now. Check your connection and try again.",
  ...
  connectedRecordsRulesTitle: "Choose exact connections",
  ...
  connectedRecordsRuleMoodJournalHint:
    "Copies only the note you wrote after your mood is saved.",
  connectedRecordsRuleJournalMood: "Explicit diary mood → mood check-in",
  connectedRecordsRuleJournalMoodHint:
    "Uses only a mood you selected in the diary; it does not read your writing.",
  connectedRecordsRuleFocusHabit: "Completed focus → mapped habit",
  connectedRecordsRuleFocusHabitHint:
    "Updates the habit you choose after a completed focus session reaches the set length.",
  connectedRecordsRuleHabitPlanning: "Habit → owned planning block",
  ...
  connectedRecordsChooseHabitError: "Choose a habit for completed focus sessions.",
  connectedRecordsChooseRuleError: "Choose at least one connection.",
  connectedRecordsSaveRules: "Save rules",
  connectedRecordsSaved: "Connected-record rules saved.",
  connectedRecordsSaveError: "Connected-record rules could not be saved.",
  ...
  connectedRecordsRequiresOnline: "Connect to the internet to turn this on.",
  connectedRecordsLoadError: "Connected-record settings are unavailable.",
  connectedRecordsDisableError: "Connected records could not be turned off.",
  connectedRecordsDisabled: "Connected records are off.",
  ...
  automationHistorySignInRequired: "Sign in to view connected-record history.",
  ...
  automationHistoryStatusPending: "Pending",
  ...
  storageTimeoutTitle: "Some saved information is unavailable",
