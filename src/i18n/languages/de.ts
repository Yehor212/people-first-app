...
export const de: Translations = {
  ...
  legalPrivacyDescription:
    "Erfahre, wie ZenFlow deine persoenlichen Daten erhebt, verwendet und schuetzt. Deine Privatsphaere hat Prioritaet.",
  legalTermsDescription: "Lies die Nutzungsbedingungen fuer die Verwendung von ZenFlow.",
  legalLicensesDescription: "ZenFlow wurde mit folgender Open-Source-Software erstellt:",
  legalOpenInBrowser: "Im Browser oeffnen",
  ...
  account: "Konto",
  accountDescription:
    "Melden Sie sich mit E-Mail an, um Ihren Fortschritt zwischen Geräten zu synchronisieren.",
  ...
  syncDeviceSessionsFootnote: "Das ist Synchronisierungspräsenz, kein Browser-Fingerprinting und kein Journalinhalt.",
  syncDeviceCurrent: "Aktuelles Gerät",
  syncDeviceRevoked: "Widerrufen",
  syncDeviceLastSeen: "Zuletzt gesehen",
  syncRevokeDevice: "Widerrufen",
  syncRevoking: "Widerrufe",
  ...
  identityMapping: "Identitätsbasierte Gewohnheit",
  identityMappingHint:
    "Jeder Check-in ist ein kleiner Schritt zu der Person, die du wirst.",
  identityCluster: "Identitätsbereich",
  identityClusterPlaceholder: "z.B., Gesunder Körper",
  identityVerb: "Ich werde",
  identityVerbPlaceholder: "z.B., jemand, der auf seinen Körper achtet",
  identityIcon: "Identitätssymbol",
  identityDefaultVerb: "wer ich werde",
  identityVotePreview:
    "Nach dem Speichern zeigt die Karte diese Identität; jede Erledigung gibt ihr eine Stimme.",
  identityVoteFor: "Schritt zu {identity}",
