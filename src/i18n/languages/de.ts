...
export const de: Translations = {
  ...
  scheduleCompletedAt: "Abgeschlossen um",
  scheduleStart: "Start",
  scheduleEnd: "Ende",
  ...
  // Friend Challenges
  friendChallenges: "Challenges mit Freunden",
  socialHubChallengesTab: "Herausforderungen",
  ...
  trackWithFriends: "Verfolge Challenges mit Freunden",
  challengeCode: "Herausforderungscode",
  yourProgress: "Dein Fortschritt",
  challengeProgressComplete: "Zu {percent}% abgeschlossen",
  daysLeft: "Tage übrig",
  dayChallenge: "Tage-Herausforderung",
  challengeCompleted: "Herausforderung abgeschlossen!",
  noChallenges: "Noch keine Challenges",
  createChallengePrompt: "Starte eine Challenge aus einer Gewohnheit!",
  ...
  challengeLookupUnavailable:
    "Diese Herausforderung konnte nicht geprüft werden. Prüfe deine Verbindung und versuche es erneut.",
  challengeInviteOffline: "Du bist offline. Stelle die Verbindung wieder her und versuche es erneut.",
  challengeInviteNotFound: "Unter diesem Code wurde keine Challenge gefunden.",
  challengeInviteExpired: "Diese Challenge ist bereits beendet.",
  challengeInviteSelf: "Das ist deine eigene Challenge.",
  challengeInviteDuplicate: "Du bist dieser Challenge bereits beigetreten.",
  challengeInviteSignedOut: "Melde dich an, um Challenges beizutreten.",
  ...
  friendInviteInvalid: "Dieser Freundescode ist ungültig. Prüfe ihn und versuche es erneut.",
  friendInviteSelf: "Das ist dein eigener Freundescode.",
  friendInviteDuplicate: "Diese Person ist bereits in deiner Freundesliste.",
  friendInviteOffline: "Du bist offline. Stelle die Verbindung wieder her und versuche es erneut.",
  friendInviteNotFound: "Dieser Freundescode wurde nicht gefunden. Prüfe ihn und versuche es erneut.",
  friendInviteSignedOut: "Melde dich an, um Freunde hinzuzufügen.",
  friendInviteUnavailable: "Die Freundesuche ist derzeit nicht verfügbar. Versuche es später erneut.",
  friendProfilePreparing: "Dein Freundes-Code wird vorbereitet…",
  friendProfileUnavailable: "Dein Freundes-Code ist gerade nicht verfügbar. Prüfe die Verbindung und versuche es erneut.",
  ...
  connectedRecordsTitle: "Verknüpfte Einträge",
  connectedRecordsDescription: "Ausgewählte ZenFlow-Bereiche dürfen einander aktualisieren.",
  connectedRecordsToggle: "Verknüpfte Einträge",
  connectedRecordsToggleHint: "Ohne deine Aktivierung wird nichts verknüpft.",
  connectedRecordsRulesTitle: "Genaue Verknüpfungen auswählen",
  connectedRecordsRulesDescription:
    "Diese Regeln ändern nur die unten genannten Einträge. Texte oder Gefühle werden nicht abgeleitet.",
  connectedRecordsRuleMoodJournal: "Stimmungsnotiz → Tagebucheintrag",
  connectedRecordsRuleMoodJournalHint:
    "Kopiert nur deine eigene Notiz, nachdem die Stimmung gespeichert wurde.",
  connectedRecordsRuleJournalMood: "Gewählte Tagebuchstimmung → Stimmungseintrag",
  connectedRecordsRuleJournalMoodHint:
    "Verwendet nur die von dir gewählte Stimmung und liest deinen Text nicht.",
  connectedRecordsRuleFocusHabit: "Abgeschlossener Fokus → gewählte Gewohnheit",
  connectedRecordsRuleFocusHabitHint:
    "Aktualisiert die gewählte Gewohnheit, wenn eine abgeschlossene Fokusphase die festgelegte Dauer erreicht.",
  connectedRecordsRuleHabitPlanning: "Gewohnheit → eigener Planungsblock",
  connectedRecordsRuleHabitPlanningHint:
    "Markiert nur den ausgewählten Block desselben Datums, wenn die Gewohnheit abgeschlossen wird.",
  connectedRecordsPlanningMappingsTitle: "Zugeordnete Planungsblöcke",
  connectedRecordsPlanningMappingsDescription:
    "Wähle für jede zu verbindende Gewohnheit einen heutigen Erinnerungsblock aus.",
  connectedRecordsPlanningHabitName: "Gewohnheit",
  connectedRecordsPlanningBlockLabel: "Heutiger zugeordneter Block",
  connectedRecordsPlanningBlockNone: "Nicht verbunden",
  connectedRecordsPlanningNoBlocks:
    "Füge der Gewohnheit zuerst eine aktive Erinnerung hinzu, um einen Planungsblock zu verbinden.",
  connectedRecordsChoosePlanningBlockError:
    "Wähle mindestens einen zugeordneten Planungsblock aus.",
  connectedRecordsFocusHabit: "Gewohnheit für abgeschlossene Fokusphasen",
  connectedRecordsChooseHabit: "Gewohnheit auswählen",
  connectedRecordsChooseHabitError: "Wähle eine Gewohnheit für abgeschlossene Fokusphasen.",
  connectedRecordsChooseRuleError: "Wähle mindestens eine Verknüpfung.",
  connectedRecordsSaveRules: "Regeln speichern",
  connectedRecordsSaved: "Regeln für verknüpfte Einträge gespeichert.",
  connectedRecordsSaveError: "Regeln für verknüpfte Einträge konnten nicht gespeichert werden.",
  connectedRecordsHistory: "Verlauf ansehen und Änderungen rückgängig machen",
  connectedRecordsServiceUnavailable: "Verknüpfte Einträge sind derzeit nicht verfügbar.",
  connectedRecordsRequiresProtection: "Entsperre und schütze zuerst dein Tagebuch.",
  connectedRecordsRequiresOnline: "Stelle eine Internetverbindung her, um dies zu aktivieren.",
  connectedRecordsLoadError: "Einstellungen für verknüpfte Einträge sind nicht verfügbar.",
  connectedRecordsDisableError: "Verknüpfte Einträge konnten nicht deaktiviert werden.",
  connectedRecordsDisabled: "Verknüpfte Einträge sind deaktiviert.",
  connectedRecordsRevocationPending: "Die Deaktivierung wird nach dem erneuten Verbinden abgeschlossen.",
  connectedRecordsEnableTitle: "Verknüpfte Einträge aktivieren?",
  connectedRecordsEnableDescription: "Prüfe genau, was ZenFlow schreiben darf.",
  connectedRecordsEnableDetail:
    "Änderungen erfolgen nur nach den gewählten Regeln. Beim Deaktivieren bleibt der vorhandene Verlauf erhalten.",
  connectedRecordsEnableConfirm: "Aktivieren",
  automationHistoryTitle: "Verlauf verknüpfter Einträge",
  automationHistoryDescription: "Verschlüsselter Verlauf automatischer Änderungen.",
  automationHistorySignInRequired: "Melde dich an, um den Verlauf verknüpfter Einträge zu sehen.",
  automationHistoryError: "Der Verlauf verknüpfter Einträge ist derzeit nicht verfügbar.",
  automationHistoryLoading: "Verlauf wird geladen…",
  automationHistoryEmpty: "Noch kein Verlauf verknüpfter Einträge.",
  automationHistoryActionError: "Diese Änderung konnte nicht abgeschlossen werden.",
  automationHistoryVaultRequired: "Entsperre dein geschütztes Tagebuch, um den Verlauf zu ändern.",
  automationHistoryStatusConnected: "Verknüpft",
  automationHistoryStatusReverted: "Rückgängig gemacht",
  automationHistoryStatusPending: "Ausstehend",
  automationHistoryStatusNeedsReview: "Prüfung erforderlich",
  automationHistoryUndo: "Rückgängig machen",
  automationHistoryUndoPending: "Rückgängig angefordert",
  automationHistoryForget: "Vergessen",
  automationHistoryForgetTitle: "Diesen Verlaufseintrag vergessen?",
  automationHistoryForgetDescription:
    "Dadurch entfällt die Rückgängig-Option; Stimmung, Tagebuch, Fokus und Gewohnheiten bleiben erhalten.",
  automationHistoryForgetConfirm: "Vergessen",
  automationHistoryClearAll: "Gesamten Verlauf löschen",
  automationHistoryClearTitle: "Gesamten verknüpften Verlauf löschen?",
  automationHistoryClearDescription:
    "Dadurch werden alle Rückgängig-Optionen dauerhaft entfernt und verknüpfte Einträge deaktiviert.",
  automationHistoryClearConfirm: "Alles löschen",
  ...
  storageTimeoutCached:
    "ZenFlow zeigt die letzte verfügbare Version. Neuere Änderungen können fehlen.",
  storageTimeoutTitle: "Einige gespeicherte Informationen sind nicht verfügbar",
  storageTimeoutUnavailable:
    "ZenFlow konnte deine gespeicherten Informationen noch nicht laden. Schließe und öffne die App erneut und versuche es noch einmal.",
