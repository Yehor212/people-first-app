...
export const de: Translations = {
  ...
  scheduleDayHasEvents: "Termine vorhanden",
  googleCalendarEventsLoading: "Google-Kalender-Termine werden geladen…",
  googleCalendarEventsUnavailable: "Google-Kalender-Termine sind derzeit nicht verfügbar.",
  scheduleStart: "Start",
  scheduleEnd: "Ende",
  ...
  adProtectedSurfaceUnavailable: "Dieser Bereich konnte nicht sicher geöffnet werden. Versuche es erneut.",
  ...
  notificationPermissionTitle: "Erinnerungen erlauben?",
  notificationPermissionDescription:
    "ZenFlow kann die Stimmungs-, Fokus- und Gewohnheitserinnerungen senden, die du einschaltest.",
  notificationFeature1Title: "Stimmungserinnerungen",
  notificationFeature1Desc: "An den Tagen und zu der Uhrzeit, die du auswählst",
  notificationFeature2Title: "Gewohnheitserinnerungen",
  notificationFeature2Desc: "An den für jede Gewohnheit gespeicherten Tagen und Uhrzeiten",
  notificationFeature3Title: "Fokus-Timer",
  notificationFeature3Desc: "Wenn eine zeitgesteuerte Fokussitzung endet",
  notificationAllow: "Erinnerungen erlauben",
  notificationDeny: "Jetzt nicht",
  ...
  hyperfocusToneLabel: "Klangfarbe",
  hyperfocusToneHelp: "Hochfrequenz-Grenze; Tonhöhe und Geschwindigkeit bleiben unverändert.",
  hyperfocusToneSofter: "Weicher",
  hyperfocusToneFullSpectrum: "Volles Spektrum",
  hyperfocusToneUnavailable: "Die Klangregelung ist auf diesem Gerät nicht verfügbar.",
  hyperfocusSoundLevelSoft: "Sanft",
  hyperfocusSoundLevelDeep: "Tief",
  hyperfocusSoundLevelIntense: "Intensiv",
  ...
  navV2Archive: "Archiv",
  navV2Account: "Konto",
  backgroundMusicTitle: "Abendmusik",
  backgroundMusicStateOn: "An",
  backgroundMusicStateOff: "Aus",
  backgroundMusicStateLoading: "Wird geladen",
  backgroundMusicStateBlocked: "Zum Fortsetzen tippen",
  backgroundMusicStateUnavailable: "Nicht verfügbar",
  backgroundMusicPlayAction: "Abendmusik abspielen",
  backgroundMusicPauseAction: "Abendmusik pausieren",
  backgroundMusicPreviousAction: "Vorherige Melodie",
  backgroundMusicNextAction: "Nächste Melodie",
  backgroundMusicStatePaused: "Pausiert",
  backgroundMusicPausedMaster: "Pausiert, weil der App-Ton ausgeschaltet ist",
  backgroundMusicPausedComfort: "Pausiert, weil Hintergrundklänge ausgeschaltet sind",
  backgroundMusicPausedOtherSound: "Pausiert, während ein anderer Klang abgespielt wird",
  ...
  planningActionAddEvent: "Zeitplan öffnen, um einen Termin hinzuzufügen",
  planningActionStartFocus: "Fokus-Timer öffnen",
  ...
  navV2HabitsActionsFor: "Aktionen für „{habit}“",
  ...
  featureUnavailableProgress:
    "ZenFlow konnte deinen gespeicherten Tagebuchfortschritt auf diesem Gerät nicht prüfen. Lade die App neu und versuche es erneut. Es wurde nichts gelöscht.",
  featureUnavailableDisabled:
    "Diese Funktion ist für dieses Profil ausgeschaltet. Aktiviere sie in den Funktionseinstellungen und versuche es erneut.",
  featureUnavailableUnlock:
    "Diese Funktion ist für dieses Profil noch nicht verfügbar. Deine vorhandenen Daten wurden nicht verändert.",
  featureUnavailableGeneric:
    "Diese Funktion ist vorübergehend nicht verfügbar. Schließe diese Meldung und versuche es später erneut.",
};
