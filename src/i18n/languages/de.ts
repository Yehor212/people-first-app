...
export const de: Translations = {
  ...
  resetDataScope: "Dies entfernt lokale Stimmungen, Gewohnheiten, Fokus, Dankbarkeit, Journal-Daten, Warteschlangen und Einstellungen.",
  resetDataConfirmAction: "Daten zurücksetzen",
  data: "Daten",
  ...
  privacyDescription: "Kein verstecktes Tracking. Angemeldete Daten synchronisieren nur bei aktivierter Synchronisierung.",
  ...
  privacyPushNotifications: "Remote-Push-Benachrichtigungen",
  privacyPushNotificationsHint: "Registriert dieses Gerät für konto-basierte Push-Erinnerungen. Lokale Erinnerungen funktionieren auch ohne das.",
  ...
  themeDark: "Dunkel",
  themeSystem: "System",
  themeStyleTitle: "Glasstil",
  themeStyleDescription: "Passe Transparenz an, ohne die Lesbarkeit zu verlieren.",
  ...
  themePreviewTitle: "Vorschau",
  themePreviewDescription: "Die Vorschau zeigt Karten, Schaltflachen, Fokus und Auswahlzustande vor dem Speichern.",
  ...
  themePaletteMorningHearth: "Weiches Licht",
  themePaletteVelvetLibrary: "Tiefes Glas",
  themePaletteBotanicalPulse: "Frisches Glas",
  themePaletteQuietOled: "OLED-Glas",
  themeAccentTeal: "Blau",
  themeAccentClay: "Ton",
  ...
  settingsSoundComfortTitle: "Sensorischer Komfort",
  settingsSoundComfortDescription: "Profile stimmen Ambiente und kurze Hinweise für Web, PWA, Android, iOS und Desktop ab.",
  ...
  settingsSoundFeedbackTitle: "Audio-Komfortfeedback",
  settingsSoundFeedbackDescription: "Speichert nur lokale Komfortwahl, Plattform, Stummstatus und Lautstärkebereich.",
  settingsSoundAmbientOff: "Umgebungsklang ist im Sensorischen Komfort ausgeschaltet.",
  settingsSoundMapTitle: "Wo Klang erscheint",
  settingsSoundMapDescription: "Alle App-Audios sind lokal, starten per Tipp und gelten gemeinsam für Web, Mobilgeräte und Desktop.",
  ...
  settingsSoundCrossPlatformTitle: "Sound-Verfügbarkeit",
  settingsSoundCrossPlatformNote: "Dieselben Sound-Einstellungen gelten für Web, PWA, Android, iOS und Desktop, soweit die Plattform es zulässt.",
  settingsSoundActionMapTitle: "Karte der Aktionsklänge",
  ...
  dopamineSoundsDesc: "Lokale Bestätigungstöne und Audio-Feedback",
  ...
  feedbackPrivacyNotice:
    "Feedback kann deine Nachricht, optionale E-Mail, App-Version, Plattform, Bildschirmgröße, Sprache und Browserinfos enthalten. Nutze dies nicht für dringende Sicherheits- oder medizinische Hilfe.",
  ...
  notificationSystemSettingsDescription: "Dein Geraet oder Browser kann ZenFlow-Erinnerungen weiterhin stummschalten oder leiser machen. App-Sounds bleiben lokal, sanft und von dir steuerbar.",
  notificationSystemSettingsAndroidDescription: "Android-Benachrichtigungskategorien behalten die finale Kontrolle ueber Ton, Vibration und Sichtbarkeit jedes Kanals.",
  notificationSystemSettingsIosDescription: "iOS-Einstellungen und Fokusmodi behalten die finale Kontrolle ueber Hinweiston, Zustellung und Stil.",
  notificationSystemSettingsWebDescription: "Browser- und OS-Einstellungen koennen Erinnerungen stummschalten oder leiser machen. App-Sounds bleiben lokal und werden per Tippen gestartet.",
  notificationSystemSettingsDesktopDescription: "Desktop-Browser und OS-Einstellungen behalten die finale Kontrolle ueber Zustellung und Ton der Erinnerungen.",
  ...
  journalResetCodeSentHint: "Klicke auf den Link in der E-Mail, um die Tagebuch-Sperre zu entfernen.",
  ...
  journalResetCheckEmail:
    "Klicke den Link in der E-Mail, um die Tagebuch-Sperre zu entfernen. Diese Seite aktualisiert sich automatisch.",
