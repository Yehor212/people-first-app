...
export const de: Translations = {
  ...
  identityMapping: "Identitätszuordnung",
  identityMappingHint: "Verbinde diese Gewohnheit mit dem, wer du wirst",
  identityCluster: "Cluster",
  identityClusterPlaceholder: "z.B., Das achtsame Ich",
  ...
  journalBurnAThought: "Gedanken verbrennen",
  ...
  navV2HabitsAddCue: "Wann • Wo • Auslöser",
  navV2HabitsEmpty: "Pflanze deinen ersten Samen",
  navV2HabitsStartSmall: "Starte mit 3 Gewohnheiten — kleine Schritte gewinnen",
  ...
  navV2HabitsIdentityToday: "Heute baust du:",
  navV2HabitsIdentityIntention: "Jemand, der sein Wort hält",
  navV2HabitsTwoMinuteRule: "Beginne mit der 2-Minuten-Version",
  ...
  navV2HabitsOnboardingStep1: "Wähle deine Identität",
  navV2HabitsOnboardingStep2: "Setze deinen Auslöser",
  navV2HabitsOnboardingStep3: "Pflanze deine erste Gewohnheit",
  navV2HabitsCollapseGroup: "{label} einklappen",
  navV2HabitsExpandGroup: "{label} ausklappen",
  navV2HabitsBrowseLibrary: "Gewohnheitsbibliothek durchsuchen",
  ...
  orbFirstRunStep1: "Schiebe den Orb passend zu deinem Gefühl",
