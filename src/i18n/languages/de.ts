...
export const de: Translations = {
  ...
  settingsSoundCrossPlatformTitle: "Plattformbereitschaft",
  settingsSoundCrossPlatformNote: "Das gemeinsame Sound-Manifest deckt Web, PWA, Android, iOS und Desktop ab; Release-Prüfungen kontrollieren die Pakete.",
  ...
  journalLoadFailedHint: "Deine Einträge wurden nicht gelöscht. Versuche, sie erneut zu laden.",
  journalLoadFailed: "Tagebuch konnte nicht geladen werden",
