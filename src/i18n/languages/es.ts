...
export const es: Translations = {
  ...
  resetDataScope: "Esto elimina estados de ánimo, hábitos, foco, gratitud, diario, colas y ajustes locales.",
  resetDataConfirmAction: "Restablecer datos",
  data: "Datos",
  ...
  privacyDescription: "Sin rastreo oculto. Los datos con sesión se sincronizan solo si activas la sincronización.",
  ...
  privacyAds: "Anuncios con recompensa",
  privacyAdsHint: "Solo videos opcionales. El SDK de anuncios queda apagado hasta que lo actives.",
  privacyPushNotifications: "Notificaciones push remotas",
  privacyPushNotificationsHint: "Registra este dispositivo para recordatorios push de la cuenta. Los recordatorios locales funcionan sin esto.",
  ...
  themeDark: "Oscuro",
  themeSystem: "Sistema",
  themeStyleTitle: "Estilo de vidrio",
  themeStyleDescription: "Ajusta la translucidez sin perder legibilidad.",
  ...
  themePreviewTitle: "Vista previa",
  themePreviewDescription: "La vista previa muestra tarjetas, botones, foco y estados seleccionados antes de guardar.",
  ...
  themePaletteMorningHearth: "Luz suave",
  themePaletteVelvetLibrary: "Vidrio profundo",
  themePaletteBotanicalPulse: "Vidrio fresco",
  themePaletteQuietOled: "Vidrio OLED",
  themeAccentTeal: "Azul",
  ...
  settingsCloudSyncTitle: "Sincronización automática",
  settingsCloudSyncDescription:
    "Tus datos con sesión iniciada se mantienen sincronizados entre dispositivos. Los cambios locales esperan de forma segura si falla la conexión.",
  settingsCloudSyncEnabled: "Sincronización automática activa",
  settingsCloudSyncDisabledByUser: "Sincronización en pausa",
  ...
  account: "Cuenta",
  accountDescription: "Inicia sesión para sincronizar tu progreso entre dispositivos.",
  ...
  syncDeviceSessionsFootnote: "Marcar un dispositivo como inactivo lo oculta de la presencia de sincronización; no cierra sesión en ese dispositivo.",
  ...
  syncRetryHint: "Algunas acciones locales necesitan otro intento de sincronización.",
  syncInboxTitle: "Bandeja de sincronización",
  syncOutboxEmpty: "No hay acciones locales esperando.",
  syncOutboxWaiting: "Esperando sincronización",
  syncOutboxMore: "{count} más en espera",
  syncRecentActivity: "Actividad reciente de sincronización",
  syncRetryCount: "{count} reintento",
  syncActionSavedLocal: "{domain} guardado localmente",
  syncActionSynced: "{domain} sincronizado",
  syncActionNeedsRetry: "{domain} necesita reintento",
  syncActionCloudApplied: "Cambios de la nube aplicados",
  syncActionUpToDate: "Ya está actualizado",
  syncActionGapRecovered: "Brecha de sincronización recuperada",
  syncActionAnotherTab: "Otra pestaña está sincronizando",
  syncActionSignIn: "Inicia sesión para sincronizar",
  syncActionWaitingConnection: "Esperando conexión",
  syncActionNeedsAttention: "La sincronización necesita atención",
  syncActionUpdated: "Sincronización actualizada",
  syncDomainDefault: "Sincronización",
  ...
  syncDomainEvent: "Evento de sincronización",
  ...
  settingsSoundComfortTitle: "Confort sensorial",
  settingsSoundComfortDescription: "Los perfiles ajustan ambiente y señales breves en Web, PWA, Android, iOS y Desktop.",
  ...
  settingsSoundFeedbackTitle: "Comentarios de confort de audio",
  settingsSoundFeedbackDescription: "Guarda solo una elección local de confort, plataforma, silencio y rango de volumen.",
  settingsSoundAmbientOff: "El sonido ambiental está apagado en Confort sensorial.",
  settingsSoundMapTitle: "Dónde aparece el sonido",
  settingsSoundMapDescription: "Todo el audio de la app es local, se inicia con un toque y se comparte en web, móvil y escritorio.",
  ...
  settingsSoundCrossPlatformTitle: "Disponibilidad del sonido",
  settingsSoundCrossPlatformNote: "Las mismas opciones de sonido se aplican en web, PWA, Android, iOS y escritorio cuando la plataforma lo permite.",
  settingsSoundActionMapTitle: "Mapa de sonidos de acción",
  ...
  dopamineSoundsDesc: "Sonidos locales de confirmación y respuesta de audio",
  ...
  feedbackPrivacyNotice:
    "Los comentarios pueden incluir tu mensaje, email opcional, versión de la app, plataforma, tamaño de pantalla, idioma e información del navegador. No uses esto para emergencias de seguridad o ayuda médica.",
  ...
  notificationSystemSettingsDescription: "Tu dispositivo o navegador aún puede silenciar o suavizar los recordatorios de ZenFlow. Los sonidos de la app siguen siendo locales, suaves y controlados por ti.",
  notificationSystemSettingsAndroidDescription: "Las categorías de notificación de Android conservan el control final del sonido, la vibración y la visibilidad de cada canal.",
  notificationSystemSettingsIosDescription: "Los ajustes de iOS y los modos Focus conservan el control final del sonido, la entrega y el estilo de las alertas.",
  notificationSystemSettingsWebDescription: "Los ajustes del navegador y del SO pueden silenciar o suavizar recordatorios. Los sonidos de la app siguen siendo locales e iniciados con un toque.",
  notificationSystemSettingsDesktopDescription: "Los ajustes del navegador de escritorio y del SO conservan el control final de la entrega y el sonido de los recordatorios.",
  ...
  journalFavoritesEmptyHint: "Añade la etiqueta favorito a una entrada para verla aquí.",
  journalToday: "Hoy",
  ...
  journalLockHint: "Esta contraseña cifra tu diario en este dispositivo. ZenFlow no puede mostrarla; el email verificado puede quitar el bloqueo en flujos de inicio de sesión compatibles.",
  ...
  journalResetCodeSentHint: "Haz clic en el enlace del correo para quitar el bloqueo del diario.",
  ...
  journalResetNoAccount: "Inicia sesión desde Cuenta en Ajustes para quitar este bloqueo por email. No se cambió nada; tus entradas siguen protegidas.",
  ...
  journalAiPrivacyConfirm:
    "La búsqueda con IA envía el texto de búsqueda del diario y fragmentos de entradas a nuestro proveedor de IA para crear resultados privados. ¿Continuar?",
  ...
  journalPhotoInvalidType: "Tipo de archivo no compatible. Usa JPEG, PNG, WebP o HEIC.",
  ...
  journalAudioPermissionDenied: "Se necesita permiso del micrófono para grabar audio.",
  ...
  journalResetCheckEmail:
    "Haz clic en el enlace del correo para quitar el bloqueo del diario. Esta página se actualizará automáticamente.",
  ...
  journalPrivateEntry: "Entrada privada",
  journalPrivateEntryHint: "Desbloquea el modo privado para ver este recuerdo.",
