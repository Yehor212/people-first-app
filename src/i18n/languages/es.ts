...
export const es: Translations = {
  ...
  scheduleCompletedAt: "Completado a las",
  ...
  socialHubChallengesTab: "Desafíos",
  ...
  challengeProgressComplete: "{percent}% completado",
  ...
  challengeLookupUnavailable:
    "No pudimos verificar este desafío. Comprueba tu conexión e inténtalo de nuevo.",
  challengeInviteOffline: "No tienes conexión. Vuelve a conectarte e inténtalo de nuevo.",
  challengeInviteNotFound: "No encontramos un desafío con ese código.",
  challengeInviteExpired: "Este desafío ya ha terminado.",
  challengeInviteSelf: "Este es tu propio desafío.",
  challengeInviteDuplicate: "Ya te has unido a este desafío.",
  challengeInviteSignedOut: "Inicia sesión para unirte a desafíos.",
  ...
  friendInviteInvalid: "Este código de amigo no es válido. Compruébalo e inténtalo de nuevo.",
  friendInviteSelf: "Este es tu propio código de amigo.",
  friendInviteDuplicate: "Este amigo ya está en tu lista.",
  friendInviteOffline: "No tienes conexión. Vuelve a conectarte e inténtalo de nuevo.",
  friendInviteNotFound: "No encontramos ese código de amigo. Compruébalo e inténtalo de nuevo.",
  friendInviteSignedOut: "Inicia sesión para añadir amigos.",
  friendInviteUnavailable: "La búsqueda de amigos no está disponible ahora. Inténtalo más tarde.",
  friendProfilePreparing: "Preparando tu código de amigo…",
  friendProfileUnavailable: "Tu código de amigo no está disponible ahora. Comprueba la conexión e inténtalo de nuevo.",
  ...
  connectedRecordsTitle: "Registros conectados",
  connectedRecordsDescription: "Permite que las áreas elegidas de ZenFlow se actualicen entre sí.",
  connectedRecordsToggle: "Registros conectados",
  connectedRecordsToggleHint: "Nada se conecta hasta que actives esta opción.",
  connectedRecordsRulesTitle: "Elige conexiones exactas",
  connectedRecordsRulesDescription:
    "Estas reglas solo modifican los registros indicados. No deducen textos ni sentimientos.",
  connectedRecordsRuleMoodJournal: "Nota de ánimo → entrada del diario",
  connectedRecordsRuleMoodJournalHint:
    "Copia únicamente la nota que escribiste después de guardar tu ánimo.",
  connectedRecordsRuleJournalMood: "Ánimo elegido en el diario → registro de ánimo",
  connectedRecordsRuleJournalMoodHint:
    "Usa solo el ánimo que elegiste; no lee lo que escribiste.",
  connectedRecordsRuleFocusHabit: "Sesión de concentración terminada → hábito elegido",
  connectedRecordsRuleFocusHabitHint:
    "Actualiza el hábito elegido cuando una sesión terminada alcanza la duración establecida.",
  connectedRecordsRuleHabitPlanning: "Hábito → bloque propio del plan",
  connectedRecordsRuleHabitPlanningHint:
    "Marca solo el bloque exacto de esa fecha que elijas al completar el hábito.",
  connectedRecordsPlanningMappingsTitle: "Bloques de planificación dedicados",
  connectedRecordsPlanningMappingsDescription:
    "Elige uno de los bloques de recordatorio de hoy para cada hábito que quieras conectar.",
  connectedRecordsPlanningHabitName: "Hábito",
  connectedRecordsPlanningBlockLabel: "Bloque dedicado de hoy",
  connectedRecordsPlanningBlockNone: "Sin conectar",
  connectedRecordsPlanningNoBlocks:
    "Añade un recordatorio activo al hábito antes de conectar un bloque de planificación.",
  connectedRecordsChoosePlanningBlockError:
    "Elige al menos un bloque de planificación dedicado.",
  connectedRecordsFocusHabit: "Hábito actualizado por las sesiones de concentración",
  connectedRecordsChooseHabit: "Elige un hábito",
  connectedRecordsChooseHabitError: "Elige un hábito para las sesiones de concentración terminadas.",
  connectedRecordsChooseRuleError: "Elige al menos una conexión.",
  connectedRecordsSaveRules: "Guardar reglas",
  connectedRecordsSaved: "Se guardaron las reglas de registros conectados.",
  connectedRecordsSaveError: "No se pudieron guardar las reglas de registros conectados.",
  connectedRecordsHistory: "Ver historial y deshacer",
  connectedRecordsServiceUnavailable: "Los registros conectados no están disponibles ahora.",
  connectedRecordsRequiresProtection: "Primero desbloquea y protege tu diario.",
  connectedRecordsRequiresOnline: "Conéctate a internet para activar esta opción.",
  connectedRecordsLoadError: "La configuración de registros conectados no está disponible.",
  connectedRecordsDisableError: "No se pudieron desactivar los registros conectados.",
  connectedRecordsDisabled: "Los registros conectados están desactivados.",
  connectedRecordsRevocationPending: "La desactivación terminará cuando vuelvas a conectarte.",
  connectedRecordsEnableTitle: "¿Activar los registros conectados?",
  connectedRecordsEnableDescription: "Revisa exactamente qué puede escribir ZenFlow.",
  connectedRecordsEnableDetail:
    "Solo se escribirá con las reglas que elijas. Puedes desactivarlas sin borrar el historial existente.",
  connectedRecordsEnableConfirm: "Activar",
  automationHistoryTitle: "Historial de registros conectados",
  automationHistoryDescription: "Historial cifrado de cambios automáticos.",
  automationHistorySignInRequired: "Inicia sesión para ver el historial de registros conectados.",
  automationHistoryError: "El historial de registros conectados no está disponible ahora.",
  automationHistoryLoading: "Cargando historial…",
  automationHistoryEmpty: "Aún no hay historial de registros conectados.",
  automationHistoryActionError: "No se pudo completar ese cambio.",
  automationHistoryVaultRequired: "Desbloquea tu diario protegido para cambiar el historial.",
  automationHistoryStatusConnected: "Conectado",
  automationHistoryStatusReverted: "Deshecho",
  automationHistoryStatusPending: "Pendiente",
  automationHistoryStatusNeedsReview: "Requiere revisión",
  automationHistoryUndo: "Deshacer",
  automationHistoryUndoPending: "Solicitud de deshacer enviada",
  automationHistoryForget: "Olvidar",
  automationHistoryForgetTitle: "¿Olvidar este elemento del historial?",
  automationHistoryForgetDescription:
    "Esto elimina la opción de deshacer, pero conserva tus registros de ánimo, diario, concentración y hábitos.",
  automationHistoryForgetConfirm: "Olvidar",
  automationHistoryClearAll: "Borrar todo el historial",
  automationHistoryClearTitle: "¿Borrar todo el historial conectado?",
  automationHistoryClearDescription:
    "Esto elimina de forma permanente todas las opciones de deshacer y desactiva los registros conectados.",
  automationHistoryClearConfirm: "Borrar todo",
  ...
  storageTimeoutCached:
    "ZenFlow muestra la última copia disponible. Es posible que falten cambios recientes.",
  storageTimeoutTitle: "Parte de la información guardada no está disponible",
  storageTimeoutUnavailable:
    "ZenFlow aún no pudo cargar la información guardada. Cierra y vuelve a abrir la aplicación, e inténtalo de nuevo.",
