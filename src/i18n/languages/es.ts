...
export const es: Translations = {
  ...
  visualTimeAwareness: "Conciencia visual del tiempo",
  ...
  adhdTimeManagement: "Planificación flexible del tiempo",
  ...
  errorBoundarySafeBody:
    "El modo de recuperación pausó solo esta pantalla. El error reciente se guardó en este dispositivo.",
  ...
  // Database recovery
  databaseRecoveryTitle: "Los datos de este dispositivo se reiniciaron",
  databaseRecoveryDesc:
    "El almacenamiento de este dispositivo fue borrado. Intentaremos restaurar tus datos desde la copia en línea.",
  databaseRecoveryRestore: "Restaurar desde la copia en línea",
  ...
  offlineBannerPending: "cambios esperando guardarse en línea",
