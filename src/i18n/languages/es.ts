...
export const es: Translations = {
  ...
  ...defineJournalRecoveryTranslations([
    "Esta función está desactivada en los ajustes de ZenFlow.",
    "Esta función aparecerá cuando hayas registrado un poco más de actividad en ZenFlow.",
    "ZenFlow está comprobando tu actividad reciente. Vuelve a intentarlo en un momento.",
    "ZenFlow no pudo comprobar tu actividad reciente en este dispositivo. No se cambió nada. Inténtalo de nuevo.",
    ...
    "Entradas del diario que no se pueden mostrar ahora: {count}. Tus datos guardados no se eliminaron.",
    ...
    "Continuar quitando el bloqueo del diario",
    "Reintentar la limpieza en línea",
    "Reintentando...",
    ...
    "Tu diario todavía se está vinculando a esta cuenta. Mantén la aplicación abierta y la sesión iniciada, y vuelve a intentarlo. No se ha cambiado nada.",
    ...
    "No se pudo iniciar la verificación de la cuenta. No se cambió nada. Comprueba la conexión e inténtalo de nuevo.",
    "Comprobando la cuenta propietaria de este diario...",
    "ZenFlow solo verificará la misma cuenta; no cambiará el diario ni su contraseña.",
    "Inicia sesión en la cuenta propietaria de este diario y vuelve a empezar la verificación. No se cambió nada.",
    "Esta cuenta no tiene un método de acceso disponible en este dispositivo. Abre los ajustes de la cuenta y verifica primero un método de acceso.",
    "Enviaremos un enlace de verificación al correo de la cuenta propietaria de este diario.",
    "Abre el enlace en este dispositivo y vuelve a ZenFlow. Verifica la cuenta, pero no quita la protección del diario.",
    "Cuenta verificada. Desbloquea el diario si hace falta y vuelve a intentar quitar la protección.",
    "Cuenta verificada",
    "Desbloquea el diario si hace falta y vuelve a intentar quitar la protección. La verificación por sí sola no cambió el diario ni la contraseña.",
    "Cerrar y desbloquear el diario",
    "Volver a intentar quitar la protección",
    "Enviaremos un código de un solo uso al teléfono de esta cuenta. La verificación por sí sola no cambiará el diario.",
    "Verificar por teléfono",
    "Enviar un código de un solo uso a",
    "Enviar código",
    "Introduce el código de verificación",
    "Código de verificación",
    "Introduce el código de verificación de 6 dígitos.",
    "Verificar",
    "Elige un método que ya esté vinculado a esta cuenta. El diario no cambiará hasta que vuelvas a pedir expresamente quitar la protección.",
    "Usa un método de acceso vinculado",
    "Verificar con {provider}",
  ...
  settingsSoundPreviewDescription: "Escucha cada señal activada ahora, sin esperar un evento real.",
