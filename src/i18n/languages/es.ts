...
export const es: Translations = {
  ...
  journalResetNoAccount: "Inicia sesión en Ajustes para usar la eliminación del bloqueo por email",
  journalResetEncryptedUnavailable: "Este diario está cifrado con tu contraseña. La verificación por email no puede quitar este bloqueo mientras el contenido cifrado esté bloqueado. Desbloquéalo con tu contraseña para quitarlo.",
