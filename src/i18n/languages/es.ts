...
export const es: Translations = {
  ...
  scheduleDayHasEvents: "Hay eventos programados",
  googleCalendarEventsLoading: "Cargando eventos de Google Calendar…",
  googleCalendarEventsUnavailable: "Los eventos de Google Calendar no están disponibles ahora.",
  ...
  notificationPermissionTitle: "¿Permitir recordatorios?",
  notificationPermissionDescription:
    "ZenFlow puede enviar los recordatorios de ánimo, concentración y hábitos que actives.",
  notificationFeature1Title: "Recordatorios de ánimo",
  notificationFeature1Desc: "En los días y a la hora que elijas",
  notificationFeature2Title: "Recordatorios de hábitos",
  notificationFeature2Desc: "En los días y a la hora guardados para cada hábito",
  notificationFeature3Title: "Temporizador de concentración",
  notificationFeature3Desc: "Cuando termina una sesión de concentración cronometrada",
  notificationAllow: "Permitir recordatorios",
  notificationDeny: "Ahora no",
  ...
  backgroundMusicPreviousAction: "Melodía anterior",
  backgroundMusicNextAction: "Siguiente melodía",
  backgroundMusicStatePaused: "En pausa",
  ...
  planningActionAddEvent: "Abrir el horario para añadir un evento",
  planningActionStartFocus: "Abrir el temporizador de concentración",
  ...
  navV2HabitsActionsFor: "Acciones para «{habit}»",
  ...
  featureUnavailableProgress:
    "ZenFlow no pudo comprobar el progreso guardado de tu diario en este dispositivo. Vuelve a cargar la aplicación e inténtalo de nuevo. No se eliminó nada.",
  featureUnavailableDisabled:
    "Esta función está desactivada para este perfil. Actívala en los ajustes de funciones y vuelve a intentarlo.",
  featureUnavailableUnlock:
    "Esta función todavía no está disponible para este perfil. Tus datos existentes no han cambiado.",
  featureUnavailableGeneric:
    "Esta función no está disponible temporalmente. Cierra este mensaje y vuelve a intentarlo más tarde.",
};
