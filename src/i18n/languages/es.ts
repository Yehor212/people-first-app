...
export const es: Translations = {
  ...
  settingsSoundCrossPlatformTitle: "Preparación multiplataforma",
  settingsSoundCrossPlatformNote: "El manifiesto de sonido compartido cubre Web, PWA, Android, iOS y Desktop; la prueba de lanzamiento revisa los paquetes.",
  ...
  journalLoadFailedHint: "Tus entradas no se borraron. Intenta cargarlas de nuevo.",
  journalLoadFailed: "No se pudo cargar el diario",
