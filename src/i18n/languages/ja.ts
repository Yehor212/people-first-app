...
export const ja: Translations = {
  ...
  navV2HabitsAddCue: "いつ • どこで • きっかけ",
  navV2HabitsEmpty: "最初の種を植えよう",
  navV2HabitsStartSmall: "3つの習慣から始めよう — 小さな一歩が勝つ",
  ...
  navV2HabitsIdentityToday: "今日あなたは作り上げています：",
  navV2HabitsIdentityIntention: "約束を守る人",
  navV2HabitsTwoMinuteRule: "2分版から始めましょう",
  ...
  navV2HabitsOnboardingStep1: "アイデンティティを選ぶ",
  navV2HabitsOnboardingStep2: "きっかけを設定",
  navV2HabitsOnboardingStep3: "最初の習慣を植える",
  navV2HabitsCollapseGroup: "{label}を折りたたむ",
  navV2HabitsExpandGroup: "{label}を展開",
  navV2HabitsBrowseLibrary: "習慣ライブラリを見る",
  ...
  orbFirstRunStep1: "気持ちに合わせてオーブをスライド",
