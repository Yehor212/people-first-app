...
export const ja: Translations = {
  ...
  syncDeviceSessionsFootnote: "これは同期プレゼンスであり、ブラウザー指紋や日記の内容ではありません。",
  syncDeviceCurrent: "現在のデバイス",
  syncDeviceRevoked: "取り消し済み",
  syncDeviceLastSeen: "最終表示",
  syncRevokeDevice: "取り消す",
  syncRevoking: "取り消し中",
  syncPriority: "重要",
  ...
  identityMapping: "アイデンティティ型の習慣",
  identityMappingHint: "毎回のチェックインが、なりたい自分への一歩になります。",
  identityCluster: "アイデンティティ領域",
  identityClusterPlaceholder: "例：健康な体",
  identityVerb: "私はこうなっている",
  identityVerbPlaceholder: "例：体を大切にする人",
  identityIcon: "アイデンティティのシンボル",
  identityDefaultVerb: "なりたい自分",
  identityVotePreview:
    "保存後、習慣カードにこのアイデンティティが表示され、完了するたびに1票が加わります。",
