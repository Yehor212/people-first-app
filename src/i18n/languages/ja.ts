...
export const ja: Translations = {
  ...
  themeDark: "ダーク",
  themeSystem: "システム",
  themeStyleTitle: "ムードパレット",
  themeStyleDescription: "読みやすさを保つ調整済みの見た目を選びます。",
  ...
  themePaletteMorningHearth: "朝のぬくもり",
  themePaletteVelvetLibrary: "ベルベット書斎",
  themePaletteBotanicalPulse: "ボタニカルパルス",
  themePaletteQuietOled: "静かなOLED",
