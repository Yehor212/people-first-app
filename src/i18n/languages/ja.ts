...
export const ja: Translations = {
  ...
  resetDataScope: "ローカルの気分、習慣、集中、感謝、日記、キュー、設定が削除されます。",
  resetDataConfirmAction: "データをリセット",
  data: "データ",
  ...
  privacyPushNotifications: "リモートプッシュ通知",
  privacyPushNotificationsHint: "アカウント連携のプッシュリマインダー用にこの端末を登録します。ローカル通知はこれなしで動作します。",
  ...
  themeDark: "ダーク",
  themeSystem: "システム",
  themeStyleTitle: "ガラススタイル",
  themeStyleDescription: "文字の読みやすさを保ちながら透明感を調整します。",
  themeAccentTitle: "アクセント",
  themeAccentDescription: "フォーカス、選択状態、主要操作に使う色です。",
  themeIntensityTitle: "強さ",
  themeComfortTitle: "快適さ",
  themePreviewTitle: "プレビュー",
  themePreviewDescription: "保存前にカード、ボタン、フォーカス、選択状態を確認します。",
  ...
  themePaletteMorningHearth: "ソフトライト",
  themePaletteVelvetLibrary: "ディープガラス",
  themePaletteBotanicalPulse: "フレッシュガラス",
  themePaletteQuietOled: "OLEDガラス",
  themeAccentTeal: "ブルー",
  themeAccentClay: "クレイ",
  ...
  settingsSoundComfortTitle: "感覚コンフォート",
  settingsSoundComfortDescription: "Web、PWA、Android、iOS、Desktopで環境音と短い合図を調整します。",
  ...
  settingsSoundFeedbackTitle: "音の快適さフィードバック",
  settingsSoundFeedbackDescription: "ローカルの快適さ選択、プラットフォーム、ミュート状態、音量帯だけを保存します。",
  settingsSoundAmbientOff: "感覚コンフォートで環境音がオフです。",
  ...
  settingsSoundCrossPlatformTitle: "サウンドの利用範囲",
  settingsSoundCrossPlatformNote: "同じサウンド設定は、プラットフォームが対応する範囲で Web、PWA、Android、iOS、Desktop に適用されます。",
  ...
  dopamineSounds: "サウンド",
  dopamineSoundsDesc: "ローカルの確認音と音声フィードバック",
  dopamineHaptics: "触覚",
  ...
  feedbackPrivacyNotice:
    "フィードバックには、メッセージ、任意のメール、アプリ版、プラットフォーム、画面サイズ、言語、ブラウザ情報が含まれる場合があります。緊急の安全確認や医療支援には使わないでください。",
  feedbackSubmit: "送信",
  ...
  notificationSystemSettingsDescription: "端末やブラウザ側の設定で、ZenFlowのリマインダーをミュートまたは控えめにできます。アプリ内の音はローカルで、やさしく、ユーザーが制御します。",
  notificationSystemSettingsAndroidDescription: "Androidの通知カテゴリが、各チャンネルの音・振動・表示の最終設定を保持します。",
  notificationSystemSettingsIosDescription: "iOSの設定と集中モードが、通知音・配信・表示スタイルの最終制御を持ちます。",
  notificationSystemSettingsWebDescription: "ブラウザとOSの通知設定で、リマインダーをミュートまたは控えめにできます。アプリ内の音はローカルで、タップ後に開始します。",
  notificationSystemSettingsDesktopDescription: "デスクトップのブラウザとOSの通知設定が、リマインダーの配信と音の最終制御を持ちます。",
  ...
  journalResetCodeSentHint: "メール内のリンクをクリックして日記のロックを解除してください。",
  ...
  journalResetCheckEmail:
    "メールのリンクをクリックして日記のロックを解除してください。このページは自動的に更新されます。",
