...
export const ja: Translations = {
  ...
  // TimeHelper
  timeBlindnessHelper: "ビジュアルタイマー",
  visualTimeAwareness: "選んだ長さで使えるビジュアルタイマー",
  ...
  pauseTimer: "一時停止",
  resetTimer: "リセット",
  adhdTimeManagement: "タイマーの機能",
  adhdTip1: "任意の音声通知で時間の経過を知らせます",
  adhdTip2: "カウントダウンで残り時間を表示します",
  adhdTip3: "タイマーの動作中は、終了予定時刻が表示されます",
  adhdTip4: "終了が近づくと色が変わります",
  currentStreak: "現在の連続",
  daysInRow: "連続日数",
  totalFocus: "総集中時間",
  allTime: "全期間",
  ...
  invalidNameCharacters:
    "この名前にはZenFlowで使用できない文字列が含まれています。文字、数字、空白、一般的な句読点を使用してください。",
  notifications: "通知",
  ...
  settingsSoundActivityRestoreTitle: "一部の操作音がオフになっています",
  ...
  importMode: "このバックアップをどのように使いますか？",
  ...
  sessionTimeoutDelayedTitle: "自動ログアウトを延期しました",
  sessionTimeoutPendingChanges:
    "保存待ちの変更があるため、自動ログアウトを延期しました。ZenFlow はまもなく再試行します。",
  ...
  importConfirmMessage:
    "このバックアップから新しい項目が追加され、既存の項目が更新される場合があります。バックアップで削除済みの項目は、この端末からも削除されます。",
  syncing: "更新中...",
  signingIn: "サインイン中...",
  signingOut: "サインアウト中...",
  deleting: "削除中...",
  ...
  resetDataError: "データをリセットできませんでした。もう一度お試しください。",
  resetDataSuccess: "この端末のデータをリセットしました。",
  resetting: "リセットしています…",
  privacyTitle: "プライバシー",
  privacyDescription:
  ...
  // v1.2.0 Appearance
  appearance: "外観",
  oledDarkMode: "ピュアブラックモード",
  oledDarkModeHint: "OLED画面用の真っ黒テーマ。バッテリーを節約できる場合があります。",
  themeLabel: "テーマ",
  themeLight: "ライト",
  themeDark: "ダーク",
  themeSystem: "システム",
  ...
  settingsPostCommitDeferred:
    "この設定は保存されましたが、この端末で別の変更を保存できませんでした。",
  settingsPostCommitRefresh:
    "この設定は保存されましたが、画面にはまだ最新の内容が表示されていない可能性があります。",
  ...
  themeApplied: "スタイルを適用しました",
  themeReset: "スタイルをリセットしました",
  themeUndone: "スタイルを復元しました",
  themePreviewChanged: "変更後にプレビューを解除しました",
  themePaletteZenflow: "ZenFlow",
  themePaletteMorningHearth: "朝の炉辺",
  ...
  themeIntensityQuiet: "静か",
  themeIntensityBalanced: "バランス",
  themeIntensityVivid: "鮮やか",
  themeHighContrast: "高コントラスト",
  themeHighContrastHint: "文字、境界線、フォーカス表示を強めます。",
  themeReduceGlow: "光を控える",
  themeReduceGlowHint: "暗い場所で画面を落ち着かせます。",
  themeReduceTransparency: "透明感を控える",
  themeReduceTransparencyHint: "読みやすい不透明なパネルにします。",
  ...
  whatsNew: {
    ...
    bugFixes172: {
      title: "バグ修正",
      description: "デバイス更新の問題を修正し、全体的な安定性を改善しました。",
    },
    googleOnly: {
      title: "Googleサインインのみ",
      description:
    ...
    codeQuality: {
      title: "信頼性",
      description: "見えない問題を整え、よりなめらかで信頼できる体験にしました。",
    },
  },
  ...
  settingsCloudSyncTitle: "オンラインバックアップ",
  ...
  settingsImportMergeTooltip:
    "新しい項目が追加され、すでにある項目は更新される場合があります。バックアップで削除済みの項目は、この端末からも削除されます。",
  importAccountUnavailable:
    "バックアップをインポートできるのは、アカウントを接続せずにZenFlowを使用している場合のみです。",
  settingsImportReplaceTooltip:
    "ZenFlowでバックアップされるデータは、いったんこの端末から削除されます。選択したバックアップにある項目だけが復元され、バックアップにない項目は削除されます。この端末だけに保存される設定は変わりません。",
  settingsImportReplaceAction: "バックアップで置き換える",
  settingsImportReplaceConfirm:
    "選択したバックアップでこの端末のデータを置き換えるには、「REPLACE」と入力してください。",
  ...
  settingsWhatsNewBugFixes158Desc: "デバイス更新の問題を修正し、安定性を改善しました",
  ...
  settingsModuleQuestsDesc: "デイリーミッションと進捗",
  ...
  legendAuto: "自動",
  legendSkip: "スキップ",
  reminderMoodTitle: "今の気分を確認",
  reminderMoodBody: "気が向いたら、今の気分を記録できます。",
  reminderHabitTitle: "習慣のリマインダー",
  reminderHabitBody: "小さな一歩で十分です。準備ができたときに始められます。",
  reminderFocusTitle: "集中しますか？",
  reminderFocusBody: "都合のよいときに、25分の集中セッションを始められます。",
  ...
  account: "アカウント",
  accountDescription: "サインインすると、すべてのデバイスで進捗を使えます。",
  ...
  syncDeviceLastSeen: "最終利用: {value}",
  syncDeviceLastSeenUnknown: "不明",
  syncDeviceBrowser: "ブラウザ",
  syncDeviceInstalledApp: "ZenFlow アプリ",
  syncDeviceUnknownSystem: "不明なシステム",
  syncRevokeDevice: "非アクティブにする",
  syncRevoking: "非アクティブ化中",
  syncPriority: "重要",
  syncPriorityCritical: "重要",
  syncLatestAction: "最新の操作",
  syncRetryHint: "一部の変更はもう一度試す必要があります。",
  syncInboxTitle: "デバイスからの更新",
  syncOutboxEmpty: "待機中の変更はありません。",
  syncOutboxWaiting: "オンライン保存待ち",
  syncOutboxMore: "ほか {count} 件が待機中",
  syncRecentActivity: "最近のデバイス更新",
  syncRetryCount: "試行回数：{count}回",
  syncActionSavedLocal: "{domain} をこのデバイスに保存しました",
  syncActionSynced: "{domain} をオンラインに保存しました",
  syncActionNeedsRetry: "{domain} はもう一度試す必要があります",
  syncActionCloudApplied: "アカウントの更新を適用しました",
  syncActionUpToDate: "すでに最新です",
  syncActionGapRecovered: "不足していた更新を復元しました",
  syncActionAnotherTab: "別のZenFlowウィンドウが更新中です",
  syncActionSignIn: "サインインしてデバイスを最新に保つ",
  syncActionWaitingConnection: "接続を待っています",
  syncActionNeedsAttention: "デバイスの更新に確認が必要です",
  syncActionUpdated: "更新が変更されました",
  syncDomainDefault: "更新",
  syncDomainMood: "気分",
  syncDomainHabits: "習慣",
  ...
  deleteAccountWarning:
    "アカウントを削除すると、そのアカウントではZenFlowにサインインできなくなります。アカウントに保存されたデータと、この端末にあるそのアカウントのデータも削除されます。この操作は元に戻せません。送信したフィードバックは別に保存され、自動的には削除されません。",
  deleteAccountSuccess: "アカウントを削除しました。",
  deleteAccountError: "アカウント削除に失敗しました。",
  deleteAccountOutcomeUnknown:
    "アカウントが削除されたか確認できませんでした。もう一度試して、削除を確認・完了してください。",
  deleteAccountDeletedCleanupFailed:
    "アカウントは削除されましたが、このデバイスに一部のデータが残っている可能性があります。別のアカウントを使う前にZenFlowを再起動してください。",
  deleteAccountLink: "削除されるもの・残るもの",
  ...
  authImportedBackupAccountChoice:
    "ZenFlow は、このバックアップを {account} のデータと統合して結果を保存しようとします。最初の試行に失敗しても、このバックアップはこのデバイスに残ります。今すぐ再試行するか、そのまま続けると ZenFlow が自動で再試行します。データを統合した後は、自動で元に分けることはできません。",
  authImportedBackupActionFailed:
    "この操作を完了できませんでした。オンライン保存もサインアウトも確認されていません。バックアップはこのデバイスに残っています。接続を確認して、もう一度選んでください。",
  authImportedBackupDecisionSettled:
    "別の ZenFlow ウィンドウで、このバックアップの選択がすでに完了しています。先に行われた選択が適用されました。続けて結果を確認してください。",
  authImportedBackupRecoveryRequired:
    "このバックアップのローカル復旧状態を確認できません。アカウントとは分けたまま保持されます。ローカルでのアクセスを復旧するには、アカウントなしで続けてください。",
  authImportedBackupRecoveryTitle: "このバックアップの復旧方法を選択",
  authImportedBackupSaveFailed:
    "ZenFlow はこのバックアップを {account} に関連付けましたが、データの統合とオンライン保存を完了できませんでした。このバックアップはこのデバイスに残っています。今すぐ再試行するか、そのまま続けると ZenFlow が自動で再試行します。",
  authAddImportedBackupToAccount: "統合して {account} に保存",
  authKeepImportedBackupOnDevice: "このデバイスだけに残してサインアウト",
  ...
  errorBoundarySafeTitle: "復旧処理によりこの画面を停止しました",
  errorBoundarySafeBody:
    "再読み込みすると画面が復旧することがあります。保存が完了していない変更は、もう一度入力する必要があります。",
  errorBoundaryActionHint: "再読み込みすると通常は数秒でアプリに戻れます。",
  errorBoundaryReload: "アプリを再読み込み",
  errorBoundaryReloadFailed: "安全に再読み込みできませんでした。もう一度お試しください。",
  ...
  habitReminderAtLeastOneDay:
    "少なくとも1日を選択してください。このリマインダーをオフにするには削除してください。",
  ...
  yourProgress: "あなたの進捗",
  challengeProgressComplete: "達成率 {percent}%",
  daysLeft: "日残り",
  ...
  challengeLookupUnavailable:
    "このチャレンジを確認できませんでした。接続を確認して、もう一度お試しください。",
  challengeInviteOffline: "オフラインです。接続を確認して、もう一度お試しください。",
  challengeInviteNotFound: "このコードのチャレンジは見つかりませんでした。",
  challengeInviteExpired: "このチャレンジは終了しました。",
  challengeInviteSelf: "これはあなた自身のチャレンジです。",
  challengeInviteDuplicate: "このチャレンジにはすでに参加しています。",
  challengeInviteSignedOut: "チャレンジに参加するにはログインしてください。",
  ...
  friendInviteInvalid: "このフレンドコードは無効です。確認して、もう一度お試しください。",
  friendInviteSelf: "これはあなた自身のフレンドコードです。",
  friendInviteDuplicate: "このフレンドはすでにリストにいます。",
  friendInviteOffline: "オフラインです。接続を確認して、もう一度お試しください。",
  friendInviteNotFound: "このフレンドコードは見つかりませんでした。確認して、もう一度お試しください。",
  friendInviteSignedOut: "フレンドを追加するにはログインしてください。",
  friendInviteUnavailable: "現在フレンドを検索できません。時間をおいてお試しください。",
  friendProfilePreparing: "フレンドコードを準備しています…",
  friendProfileUnavailable: "現在フレンドコードを利用できません。接続を確認して、もう一度お試しください。",
  ...
  hyperfocusSoundUnderwater: "水中",
  hyperfocusSoundThunderstorm: "雷雨",
  hyperfocusSoundRain: "雨",
  hyperfocusSoundWind: "風",
  hyperfocusSoundOcean: "海",
  hyperfocusSoundRiver: "川",
  ...
  hyperfocusSoundRainSoft: "小雨",
  hyperfocusSoundRainDeep: "雨のベッド",
  hyperfocusSoundRainIntense: "強い雨",
  hyperfocusSoundWindSoft: "やさしい風",
  hyperfocusSoundWindDeep: "風のベッド",
  hyperfocusSoundWindIntense: "山の風",
  ...
  hyperfocusSoundForestSoft: "木立のそよ風",
  hyperfocusSoundForestDeep: "鳥のこずえ",
  hyperfocusSoundForestIntense: "夜の森",
  ...
  settingsSoundMasterDesc: "ZenFlow内のすべての音をオンまたはオフにします。",
  ...
  settingsSoundComfortDescription: "最初の設定を選び、下で各サウンドを調整します。",
  settingsSoundProfileQuiet: "静か",
  settingsSoundProfileRich: "豊かな音",
  ...
  settingsSoundFeedbackDescription:
    "この端末に、回答内容、回答した画面と日時、端末の種類、現在のサウンド設定を保存します。",
  ...
  widgetInfoDesc:
    "習慣を更新したり、集中セッションを終えたり、新しいバッジを獲得したりすると、ウィジェットも更新されます。",
  widgetStatus: "ウィジェットステータス",
  widgetPlatform: "デバイスの種類",
  widgetWeb: "ブラウザ（ウィジェット利用不可）",
  widgetSupport: "ウィジェットサポート",
  widgetAvailable: "利用可能",
  widgetComingSoon: "近日公開",
  widgetSetupiOS: "iPhone・iPadのウィジェット設定",
  widgetSetupAndroid: "Androidスマートフォンのウィジェット設定",
  ...
  widgetWebWarning: "ブラウザではウィジェットを利用できません",
  widgetWebWarningDesc:
    "ウィジェットはiPhone、iPad、Androidスマートフォンのモバイルアプリで使えます。追加するにはアプリをインストールしてください。",
  ...
  journalDeleteFailed: "記録を削除できませんでした。もう一度お試しください。",
  journalSaveFailedHint: "本文は画面に残っています。準備できたら再試行してください。",
  journalSaveConflictTitle: "新しい版を保持しました",
  journalSaveConflictHint:
    "この記録は別のタブまたは端末で変更されました。ここでの編集内容は残っています。新しい版を置き換える場合にだけ再試行してください。",
  journalSaveConflictRetry: "新しい版を置き換える",
  journalRetry: "再試行",
  journalSynced: "最新です",
  journalMilestone: "語！",
  todayHabits: "今日の習慣",
  ...
  fontScaleXL: "特大",
  fontScaleXXL: "最大",
  syncStatusSynced: "最新です",
  syncStatusSyncing: "更新中...",
  syncStatusPending: "変更が待機中",
  syncStatusOffline: "オフライン",
  syncStatusNotSignedIn: "未ログイン",
  syncStatusError: "更新できませんでした",

  dailyRewards: "デイリーチェックイン",
  loginStreak: "ログイン連続",
  day: "日目",
  claim: "受け取る！",
  claimed: "受取済み",
  ...
  connectedRecordsTitle: "連携する記録",
  connectedRecordsDescription: "選んだ ZenFlow の項目どうしで記録を更新できます。",
  connectedRecordsToggle: "記録を連携する",
  connectedRecordsToggleHint: "ここで有効にするまで、記録は連携されません。",
  connectedRecordsRulesTitle: "連携内容を選ぶ",
  connectedRecordsRulesDescription:
    "選んだ記録だけを更新します。文章や気持ちを推測することはありません。",
  connectedRecordsRuleMoodJournal: "気分メモ → 日記の記録",
  connectedRecordsRuleMoodJournalHint: "気分を保存した後、あなたが書いたメモだけをコピーします。",
  connectedRecordsRuleJournalMood: "日記で選んだ気分 → 気分の記録",
  connectedRecordsRuleJournalMoodHint: "選んだ気分だけを使い、日記の文章は読みません。",
  connectedRecordsRuleFocusHabit: "完了した集中 → 選んだ習慣",
  connectedRecordsRuleFocusHabitHint:
    "完了した集中時間が設定値に達したとき、選んだ習慣を更新します。",
  connectedRecordsRuleHabitPlanning: "習慣 → 専用の予定枠",
  connectedRecordsRuleHabitPlanningHint:
    "習慣を完了したとき、選んだ同じ日付の予定枠だけを完了にします。",
  connectedRecordsPlanningMappingsTitle: "専用の予定枠",
  connectedRecordsPlanningMappingsDescription:
    "連携する習慣ごとに、今日のリマインダー予定枠を1つ選んでください。",
  connectedRecordsPlanningHabitName: "習慣",
  connectedRecordsPlanningBlockLabel: "今日の専用予定枠",
  connectedRecordsPlanningBlockNone: "連携しない",
  connectedRecordsPlanningNoBlocks:
    "予定枠を連携する前に、習慣に有効なリマインダーを追加してください。",
  connectedRecordsChoosePlanningBlockError:
    "専用の予定枠を1つ以上選んでください。",
  connectedRecordsFocusHabit: "集中を完了したときに更新する習慣",
  connectedRecordsChooseHabit: "習慣を選ぶ",
  connectedRecordsChooseHabitError: "完了した集中に使う習慣を選んでください。",
  connectedRecordsChooseRuleError: "少なくとも1つの連携を選んでください。",
  connectedRecordsSaveRules: "ルールを保存",
  connectedRecordsSaved: "記録の連携ルールを保存しました。",
  connectedRecordsSaveError: "記録の連携ルールを保存できませんでした。",
  connectedRecordsHistory: "履歴と取り消しを見る",
  connectedRecordsServiceUnavailable: "記録の連携は現在利用できません。",
  connectedRecordsRequiresProtection: "先に日記を保護してロックを解除してください。",
  connectedRecordsRequiresOnline: "有効にするにはインターネットに接続してください。",
  connectedRecordsLoadError: "記録の連携設定を利用できません。",
  connectedRecordsDisableError: "記録の連携を無効にできませんでした。",
  connectedRecordsDisabled: "記録の連携は無効です。",
  connectedRecordsRevocationPending: "再接続すると無効化が完了します。",
  connectedRecordsEnableTitle: "記録の連携を有効にしますか？",
  connectedRecordsEnableDescription: "ZenFlow が更新できる内容を確認してください。",
  connectedRecordsEnableDetail:
    "選んだルールだけが記録を更新します。無効にしても既存の履歴は削除されません。",
  connectedRecordsEnableConfirm: "有効にする",
  automationHistoryTitle: "連携した記録の履歴",
  automationHistoryDescription: "自動更新の暗号化された履歴です。",
  automationHistorySignInRequired: "履歴を見るにはサインインしてください。",
  automationHistoryError: "連携した記録の履歴は現在利用できません。",
  automationHistoryLoading: "履歴を読み込み中…",
  automationHistoryEmpty: "連携した記録の履歴はまだありません。",
  automationHistoryActionError: "この変更を完了できませんでした。",
  automationHistoryVaultRequired: "履歴を変更するには、保護された日記のロックを解除してください。",
  automationHistoryStatusConnected: "連携済み",
  automationHistoryStatusReverted: "取り消し済み",
  automationHistoryStatusPending: "処理待ち",
  automationHistoryStatusNeedsReview: "確認が必要",
  automationHistoryUndo: "取り消す",
  automationHistoryUndoPending: "取り消しを依頼済み",
  automationHistoryForget: "履歴を削除",
  automationHistoryForgetTitle: "この履歴項目を削除しますか？",
  automationHistoryForgetDescription:
    "取り消し履歴だけを削除し、気分、日記、集中、習慣の記録は残します。",
  automationHistoryForgetConfirm: "削除する",
  automationHistoryClearAll: "すべての履歴を消去",
  automationHistoryClearTitle: "連携した履歴をすべて消去しますか？",
  automationHistoryClearDescription:
    "すべての取り消し履歴を完全に削除し、記録の連携を無効にします。",
  automationHistoryClearConfirm: "すべて消去",
  innerWorld: "内なる世界",
  ...
  languageApplying: "言語を適用しています...",
  languageLoadFailed: "この言語を読み込めませんでした。接続を確認して、もう一度お試しください。",
  languageSaveFailed:
    "この言語は今すぐ使えますが、このデバイスに選択内容を保存できませんでした。そのまま続けるか、もう一度お試しください。",
  languageReminderUpdateFailed:
    "アプリの言語は変更されましたが、リマインダーは以前の言語で表示される場合があります。もう一度お試しください。",
  ...
  privacyNote: "データはこのデバイスに保存され、保護されています",
  install: "アプリをインストール",
  ...
  questsPanelSubtitle: "クエストを完了してXPとバッジを集める",
  adhdEngagementSystem: "変化と勢い",
  adhdEngagementDesc: "クエストは、ルーティンが単調に感じるときに変化とやさしい流れを加えます。",
  dailyQuest: "デイリークエスト",
  ...
  noBonusQuestAvailable: "追加クエストはありません",
  bonusQuestsHint: "追加クエストはときどき表示され、手動でも作成できます",
  questProgress: "進捗：",
  questExpired: "期限切れ",
  questType: "クエスト",
  questTips: "クエストのヒント",
  questTipDaily: "デイリークエストは24時間ごとにリセット",
  questTipWeekly: "ウィークリークエストは3倍のXP",
  questTipBonus: "追加クエストはまれで5倍のXP",
  ...
  smartRemindersNotEnoughData:
    "最近のアクティビティに基づくリマインダー提案を見るには、しばらくアプリを使ってください。",
  smartRemindersOptimized: "現在のリマインダー時間は最近のパターンに沿っています。",
  smartRemindersDescription: "最近のアクティビティに基づく提案",
  suggestions: "提案",
  highConfidence: "より強いシグナル",
  mediumConfidence: "中程度",
  lowConfidence: "提案",
  apply: "適用",
  habitRemindersOptimal: "提案された習慣時間",
  patternBased: "パターン",
  ...
  onboardingfocusTimerDescription:
    "ポモドーロタイマーで集中を深めましょう。25分に設定し、1つのタスクに集中してから休憩します。",
  ...
  onboardingquestsDescription:
    "デイリーとウィークリーのクエストは、ルーティンに変化を加えます。少し流れを作りたいときに完了しましょう。",
  ...
  onboardingtasksDescription:
    "タスクモメンタムは、緊急度とエネルギーに合わせて次の一歩を選びやすくします。",
  ...
  comebackChallengeSubtitle: "戻るためのやさしい一歩",
  ...
  reminderReconcileRestored:
    "最新のリマインダー変更を適用できませんでした。以前のスケジュールが維持されるのは、引き続き有効なリマインダーだけです。",
  ...
  notificationTestNoPermission: "権限がありません。システム設定で通知を有効にしてください。",
  ...
  authWelcomeSubtitle: "サインインすると、データを各デバイスで使えます",
  authContinueWith: "サインインして続行",
  authMeasuredBreathLabel: "やわらかな空気音",
  authMeasuredBreathPlay: "やわらかな空気音を再生",
  authMeasuredBreathPause: "やわらかな空気音を一時停止",
  ...
  authPrivacyNote:
    "データはこのデバイスに保存され、サインインするとオンラインにも保存できます。プライバシーを尊重します。",
  ...
  syncQueueFullDesc: "一部の変更はあとで処理されます。インターネットに接続してください。",
  syncQueueWarning: "多くの変更が待機中です",
  syncQueueWarningDesc: "変更をオンラインに保存するには、インターネットに接続してください。",
  storageError: "ストレージエラー",
  storageErrorDesc: "このデバイスにデータを保存する際に問題が発生しました。",
  syncTransactionFailed: "データの保存に失敗しました",
  syncTransactionFailedDesc: "データを保存できませんでした。もう一度お試しください。",
  backgroundSyncFailed: "バックグラウンド更新は利用できません",
  backgroundSyncFailedDesc: "アプリに戻ったときに、変更がオンラインに保存されます。",
  indexedDBTimeout: "ストレージが遅いです",
  indexedDBTimeoutDesc: "保存に予想以上の時間がかかっています。",
  // Database recovery
  databaseRecoveryTitle: "保存したデータを一時的に利用できません",
  databaseRecoveryDesc: "ZenFlowは何も削除していません。アプリを閉じずに、もう一度お試しください。",
  databaseRecoveryRestore: "もう一度試す",
  databaseRecoveryStartFresh: "後で",
  databaseRecoveryChecking: "確認中...",
  // Update required
  ...
  // Additional UI keys
  allDone: "完了！",
  authRequired: "オンラインバックアップから復元するにはサインインしてください。",
  average: "平均",
  calendarSelectMonth: "月を選択",
  cloudSyncError: "オンラインバックアップを更新できませんでした",
  code: "コード",
  ...
  databaseRecoveryStartFreshDesc: "このデバイスのデータがリセットされました。",
  duration: "期間",
  editName: "名前を編集",
  expired: "期限切れ",
  exporting: "エクスポート中...",
  ...
  offlineBannerPending: "オンライン保存を待っている変更は{count}件です",
  offlineBannerPending_zero: "オンライン保存を待っている変更は{count}件です",
  offlineBannerPending_one: "オンライン保存を待っている変更は{count}件です",
  offlineBannerPending_two: "オンライン保存を待っている変更は{count}件です",
  offlineBannerPending_few: "オンライン保存を待っている変更は{count}件です",
  offlineBannerPending_many: "オンライン保存を待っている変更は{count}件です",
  offlineBannerRetry: "再接続",
  offlineBannerTitle: "オフラインです",
  offlineBannerStorageLimit:
    "この変更は保存されませんでした。ZenFlowで利用できる保存容量の上限に達しました。",
  optional: "任意",
  participants: "参加者",
  ...
  storageTimeoutCached:
    "ZenFlow は最後に利用できた内容を表示しています。最近の変更が含まれていない場合があります。",
  storageTimeoutTitle: "保存した情報の一部を読み込めません",
  storageTimeoutUnavailable:
    "保存した情報をまだ読み込めません。アプリを閉じて開き直し、もう一度お試しください。",
  suggestedGoals: "おすすめ",
  ...
  journalNewEntry: "新しいエントリー",
  journalWriteEntry: "エントリーを書く",
  journalWriteFirstEntry: "最初のエントリーを書く",
  journalEntryBody: "日記本文",
  journalEntry: "エントリー",
  journalEntries: "エントリー",
  journalFavorites: "お気に入り",
  journalFavoritesEmptyTitle: "お気に入りはまだありません",
  journalFavoritesEmptyHint: "記録の星を選ぶと、ここに表示されます。",
  journalAddFavorite: "お気に入りに追加",
  journalRemoveFavorite: "お気に入りから削除",
  journalToday: "今日",
  journalYesterday: "昨日",
  journalThisWeek: "今週",
  journalEarlier: "それ以前",
  ...
  entriesDeleted: "エントリーを削除しました",
  entryDeleteFailedRestored: "このエントリーを削除できませんでした。復元しました。",
  ...
  journalPasswordCooldown: "試行回数が多すぎます。{duration}お待ちください。",
  journalPasswordHide: "パスワードを隠す",
  journalPasswordShow: "パスワードを表示",
  journalPasswordForgot: "ロックを開けませんか？",
  journalPasswordRemove: "日記のロックを解除",
  journalResetViaEmail: "メールでロックを解除",
  ...
  journalResetSendTimedOut:
    "処理に時間がかかっています。もう一度試す前にメールを確認してください。",
  journalResetResend: "リンクを再送信",
  journalResetCooldown: "別のリンクをリクエストする前に{duration}お待ちください。",
  journalResetResendReady: "新しいリンクをリクエストできるようになりました。",
  journalResetCloseHint:
    "この画面は閉じてもかまいません。リンクは、有効期限が切れるか使用されるまで有効です。",
  journalMagicConfirmTitle: "メールのリンクを確認",
  journalMagicConfirmDescription:
    "日記のためにご自身でこのメールをリクエストした場合のみ続行してください。",
  journalMagicConfirmAction: "ZenFlowで確認",
  journalMagicConfirmPending: "確認しています…",
  journalMagicConfirmError:
    "このメールリンクを確認できませんでした。日記から新しいリンクをリクエストしてください。",
  ...
  journalResetDesktopUnavailable:
    "メール確認でWeb版またはモバイルアプリのロックは解除できますが、保護された記録は復号できません。デスクトップでは日記のパスワードを使用してください。",
  journalClose: "閉じる",
  journalSearch: "エントリーを検索...",
  journalAiSearchPlaceholder: "探したい内容を説明してください...",
  journalAiSwitchToTextSearch: "テキスト検索に切り替え",
  journalAiSwitchToAiSearch: "プライベート検索に切り替え",
  journalAiSearchOn: "プライベート検索がオンです",
  journalAiIndexing: "プライベート検索を準備中...",
  journalAiPrivacyConfirm:
    "プライベート検索はZenFlowアカウント内の日記だけを対象にします。検索文と日記はSupabase上のZenFlow機能で処理され、外部AIプロバイダーには送信されず、別の検索インデックスも作成されません。続けますか？",
  journalAiSearchPrivacy: "プライベート検索のプライバシー",
  journalAiSearchOff: "プライベート検索はオフです。通常のテキスト検索はこの端末内で動作します。",
  journalAiRevoke: "プライベート検索をオフにして許可を削除",
  journalAiRevoking: "プライベート検索をオフにしています...",
  journalAiRevokePending:
    "プライベート検索はオフです。オンラインになったときに許可の削除を再試行します。",
  journalAiConsentUnavailable:
    "このプライバシー設定を完了できませんでした。プライベート検索はオフのままです。接続とアカウントを確認して、もう一度お試しください。",
  journalAiConsentAccept: "プライベート検索をオンにする",
  ...
  journalPrompt: "ヒント",
  journalUsePrompt: "ヒントを選ぶ",
  journalStickerPackEnableLabel: "{pack}を有効にする",
  journalStickerPackDisableLabel: "{pack}を無効にする",
  journalHistoryLoadPending: "以前の日記を読み込んでいます…",
  journalHistoryLoadFailed: "一部の以前の日記はまだ表示できません",
  journalHistoryLoadFailedHint:
    "表示中の日記は保存されています。残りをもう一度読み込んでください。",
  journalRetryHistory: "以前の日記を再読み込み",
  ...
  journalRemoveSticker: "スタンプを削除",
  journalStickerSelect: "スタンプを追加",
  ...
  journalReminderSaveError: "リマインダーを変更できませんでした。もう一度お試しください。",
  journalReminderStateUnknown:
    "リマインダーの状態を確認できませんでした。この設定を開き直して、もう一度お試しください。",
  journalStreakFrozenToday: "今日の記録継続は保護されています",
  journalStreakFreezesAvailable: "継続保護を{count}回利用できます",
  journalInactiveBanner:
    "最後の記録から{days}日たちました。今助けになるなら、短く書き始めましょう。",
  journalInactiveBannerCountZero:
    "最後の記録から{count}日たちました。今助けになるなら、短く書き始めましょう。",
  ...
  journalAudioRecordingLabel: "音声録音{number}、{duration}",
  journalAudioPlay: "再生: {label}",
  journalAudioPause: "一時停止: {label}",
  journalAudioProgress: "再生の進行状況: {label}",
  journalAudioPlaybackError: "この録音を再生できませんでした。もう一度お試しください。",
  journalAudioRetry: "もう一度試す: {label}",
  journalAudioLoading: "読み込み中: {label}",
  journalAudioPreparing: "マイクを準備しています...",
  journalAudioPreparingDescription:
    "システムの確認画面で「許可」を選択してください。許可後にのみ録音が始まります。",
  journalAudioLoadError: "この記録の音声を読み込めませんでした。",
  journalAudioLoadRetry: "音声をもう一度読み込む",
  journalAudioRemoveError: "この録音を削除できませんでした。",
  journalAudioPermissionDenied:
    "マイクへのアクセスがオフになっています。音声なしで書き続けるか、ブラウザまたは端末の設定でアクセスを許可できます。",
  journalAudioInputMissing: "マイクが見つかりません。音声なしで書き続けられます。",
  journalAudioInputUnavailable:
    "マイクが使用中か、利用できません。書き続けて、後でもう一度お試しください。",
  journalAudioStartError: "マイクを開始できませんでした。音声なしで書き続けられます。",
  journalAudioUnsupported: "このデバイスでは音声録音に対応していません。",
  journalVoiceNotSupported: "このブラウザでは音声認識がサポートされていません",
  journalVoiceError:
    "音声入力が停止しました。認識された言葉はここに残っています。準備ができたらもう一度お試しください。",
  journalAudioSaveRetryTitle: "録音はまだ追加されていません",
  journalAudioSaveRetryDescription:
    "録音は保持されています。もう一度追加するか、破棄してください。",
  journalAudioSaveRetry: "もう一度試す",
  journalAudioRemoveTitle: "この録音を削除しますか？",
  journalAudioRemoveDescription: "この録音は日記から削除されます。元に戻すことはできません。",
  journalAudioRemoveDescriptionStaged:
    "保存すると、この録音は日記から削除されます。変更を破棄した場合、録音は日記に残ります。",
  journalAudioRemoveConfirm: "録音を削除",
  ...
  journalRecordingPaused: "録音を一時停止しました",
  ...
  journalBurnReleasedMessage: "テキストを削除しました。",
  journalBurnPlaceholder: "心配事を書いてください...",
  journalBurnAction: "燃やす",
  journalReleaseFinalTitle: "手放しました",
  journalReleaseFinalSubtitle:
    "テキストを削除しました。ZenFlowは、内部ID、手放しの種類、所要時間、開始日時と完了日時を含むテキストなしの記録を、この端末と作成したバックアップに保存しました。",
  journalReleaseBeforeAction:
    "このテキストは削除されます。ZenFlowは、内部ID、手放しの種類、所要時間、開始日時と完了日時を含むテキストなしの記録を、この端末と作成したバックアップに保存します。",
  journalReleaseTraceSaveFailed:
    "テキストは削除されましたが、ZenFlowは手放しの記録を保存できませんでした。テキストの内容は一切保存されていません。",
  keyboardShortcuts: "キーボードショートカット",
  journalShortcutNavigation: "ナビゲーション",
  journalShortcutToggleSidebar: "サイドバーを表示または非表示",
  journalShortcutToggleCompact: "コンパクトなサイドバーを使用",
  journalShortcutCloseOrBack: "閉じる、または戻る",
  journalShortcutEditor: "エディター",
  journalShortcutView: "日記",
  journalShortcutSaveEntry: "記録を保存",
  journalShortcutShowHelp: "ショートカットを表示",
  journalMoodInsights: "気分の傾向",
  journalMoodInsightsMoreData: "書き続けると、気分の傾向が見えてきます。",
  journalMoodInsightBestDay: "記録した気分が最も高い曜日は{day}です",
  journalMoodInsightAverage: "平均 {value} / 5",
  journalMoodInsightLonger: "長い記録は、記録した気分の高さと関連しています",
  journalMoodInsightShorter: "短い記録は、記録した気分の高さと関連しています",
  journalMoodInsightPointDifference: "{value}ポイントの差",
  journalMoodInsightBestTime: "{period}に書いたとき、記録した気分が最も高くなっています",
  journalMoodInsightMorning: "朝",
  journalMoodInsightAfternoon: "午後",
  journalMoodInsightEvening: "夜",
  journalMoodInsightStreak: "連続して書いた日は、記録した気分が高くなっています",
  journalMoodInsightStreakDifference: "連続した日は+{value}ポイント",
  journalMoodInsightMedia: "写真や音声を含む記録は、記録した気分の高さと関連しています",
  journalMoodInsightTextOnly: "テキストのみの記録は、記録した気分の高さと関連しています",
  journalReleaseTraceSingle: "思考を手放しました",
  journalReleaseTraceLatest: "最後 {time}",
  journalReleaseTraceCountZero: "{count}件の削除記録",
  journalReleaseTraceCountOne: "{count}件の削除記録",
  journalReleaseTraceCountTwo: "{count}件の削除記録",
  journalReleaseTraceCountFew: "{count}件の削除記録",
  journalReleaseTraceCountMany: "{count}件の削除記録",
  journalReleaseTraceCountOther: "{count}件の削除記録",
  ...
  journalResetCheckEmail:
    "この端末またはブラウザでリンクを開き、そのあと日記に戻ってください。アカウントを確認し、古いパスワードを明かさずにロックを解除します。",
  ...
  journalImport: "インポート",
  journalImportHint:
    "インポート前に、このZenFlowバックアップで追加または削除される内容を確認してください。",
  journalImporting: "バックアップをインポートしています...",
  journalSettingsBusy: "この変更を完了しています...",
  journalImportSuccess: "インポート完了",
  journalImportSyncPending: "この端末に保存しました。同期は自動的に再試行されます。",
  journalImportDeletedHistory: "削除履歴",
  journalImportDeletionWarning:
    "このバックアップには削除済みの記録が{count}件含まれています。この端末の同じ記録は完全に削除されます。",
  journalImportLegacyWarning:
    "この古いバックアップには削除履歴がないため、以前削除した記録が復元される場合があります。",
  journalImportRemoved: "削除",
  ...
  journalExportCSV: "スプレッドシートファイル（CSV）",
  journalExportCSVDesc: "スプレッドシート形式",
  journalExportPDF: "印刷用ファイル（PDF）",
  ...
  journalExportStarted: "ダウンロードを開始しました",
  journalExportFailed: "エクスポートに失敗しました。もう一度お試しください。",
  journalExportDate: "日付",
  journalExportTime: "時刻",
  journalExportTitle: "タイトル",
  journalExportContent: "本文",
  journalExportMood: "気分",
  journalExportTags: "タグ",
  journalExportStickers: "ステッカー",
  journalExportWordCount: "単語数",
  journalExportPhotos: "写真",
  journalExportAudio: "音声",
  journalExportUntitled: "無題",
  journalExportDiary: "日記",
  journalExportExported: "{date}に書き出し",
  journalExportLoadingEntries: "記録を読み込んでいます...",
  journalExportLoadingPhotos: "写真を読み込んでいます...",
  journalExportLoadingAudio: "音声を読み込んでいます...",
  journalExportGeneratingFile: "ファイルを作成しています...",
  journalExportGeneratingPages: "ページを作成しています...",
  journalExportLoadingEntryPhotos: "記録{current}の写真を読み込んでいます...",
  ...
  journalAiSearchUnavailable: "プライベート検索は現在利用できません",
  journalSlashCommands: "日記コマンド",
  journalSlashNoResults: "日記コマンドが見つかりません",
  journalFormatBold: "太字",
  journalFormatItalic: "斜体",
  journalFormatUnderline: "下線",
  journalFormatStrikethrough: "取り消し線",
  journalFormatQuote: "引用",
  journalFormatCode: "コード",
  journalFormatLink: "リンク",
  journalReflectionPrompt1: "注意を求めている瞬間に名前をつける。",
  journalReflectionPrompt2: "今日について本当の一文を書く。",
  journalReflectionPromptPast: "その日の記憶について、本当のことを一文書く。",
  journalReflectionPrompt3: "体、気分、集中に何が変わったかを見る。",
  journalReflectionPrompt4: "未来の自分に残したい細部だけを残す。",
  journalReflectionPrompt5: "小さく始める：場所、感覚、次の一歩。",
  journalReflectionPrompt6: "あとで見返せるように、この考えをここに置いておく。",
  journalReflectionQuoteLabel: "静かな引用",
  journalReflectionQuote1: "ひとつの細部だけで十分です。",
  journalReflectionQuote2: "このページには、あなたが選ぶものだけを置けます。",
  journalReflectionQuote3: "あとで戻れる小さなメモを残しましょう。",
  ...
  journalSlashMoodLabel: "気分",
  journalSlashMoodDescription: "エントリーの気分を設定",
  journalSlashHeadingLabel: "見出し",
  journalSlashHeadingDescription: "見出しを挿入",
  journalSlashQuoteLabel: "引用",
  journalSlashQuoteDescription: "引用ブロックを挿入",
  journalSlashChecklistLabel: "チェックリスト",
  journalSlashChecklistDescription: "チェックリストを挿入",
  journalSlashBreatheLabel: "呼吸",
  journalSlashBreatheDescription: "呼吸エクササイズを開く",
  journalSlashGratitudeLabel: "感謝",
  journalSlashGratitudeDescription: "感謝のプロンプトを追加",
  journalSlashBurnLabel: "手放す",
  journalSlashBurnDescription: "思考を手放す",
  journalSlashFocusLabel: "集中",
  journalSlashFocusDescription: "集中執筆モードを開く",
  journalSlashTemplateLabel: "テンプレート",
  journalSlashTemplateDescription: "日記テンプレートを選ぶ",
  journalSlashPhotoLabel: "写真",
  ...
  journalPrivateEntry: "記録のプレビューは非表示です",
  journalPrivateEntryHint: "この記録を表示するには、日記の画面プライバシー設定を変更してください。",
  ...
  journalBreathePause: "呼吸エクササイズを一時停止",
  journalBreatheResume: "呼吸エクササイズを再開",
  journalFocusSceneTitle: "書く前に集中",
  journalFocusSceneDescription: "ひと呼吸してから、集中ノートを開きます。",
  journalFocusStartEntry: "集中ノートを開く",
  diaryPrivacyShield: "画面シールド",
  diaryPrivacyShieldHint: "この画面のエディターを一時的に隠します。日記はロックされません。",
  ...
  diarySidebarShow: "日記パネルを開く",
  diarySidebarHide: "日記パネルを閉じる",
  ...
  diaryPhotoGestureHint: "ドラッグで移動、ピンチでサイズ変更、タップで操作メニューを開きます。",
  diaryPhotoDescribe: "写真を説明",
  diaryPhotoDescriptionLabel: "写真の説明",
  diaryPhotoDescriptionHelp:
    "スクリーンリーダー向けに、この写真で大切なことを説明します。意味を加えない写真なら空欄にしてください。",
  diaryPhotoGestureInstructions:
    "ドラッグで移動し、ピンチでサイズを変更します。写真を選択すると操作メニューが開きます。キーボードでは、矢印キーで移動、プラスまたはマイナスでサイズ変更、Homeキーで中央に移動、Deleteキーでギャラリーに戻します。",
  diaryPhotoInteractionLabel:
    "{total}枚中{current}枚目の写真。移動やサイズ変更ができます。選択すると操作メニューが開きます。",
  diaryPhotoInteractionLabelWithDescription:
    "{total}枚中{current}枚目の写真：{description}。移動やサイズ変更ができます。選択すると操作メニューが開きます。",
  diaryPhotoLayoutStatus: "{total}枚中{current}枚目の写真。位置{x}、{y}。幅{width}。",
  diaryPhotoMove: "写真を移動",
  diaryPhotoTapDestination: "写真を選択しました。配置したい場所をタップしてください。",
  diaryScene: "シーン",
  diaryTexture: "質感",
  ...
  journalBackgroundSelected: "背景：{value}",
  journalFontSizeSelected: "文字サイズ：{value}",
  journalMotionSelected: "動き：{value}",
  journalSceneSelected: "シーン：{value}",
  journalTextureSelected: "質感：{value}",
  journalDraftInUse:
    "この記録は別のウィンドウで開かれています。そちらを閉じてから、もう一度お試しください。",
  ...
  journalPanicLeave: "日記から離れる",
  journalPanicLeaveHint: "下書きを保存して、内容を隠した日記一覧に戻ります。",
  journalPanicLeaveWithoutSaving: "保存せずに離れる",
  journalPanicExitSaveError:
    "最新の変更を保存できませんでした。日記は引き続き隠されています。変更が失われてもよい場合にのみ、保存せずに離れてください。",
  ...
  journalRecordingDiscardTitle: "この録音を破棄しますか？",
  journalRecordingDiscardDescription:
    "この音声はまだ記録に追加されていません。破棄すると元に戻せません。",
  ...
  openPhoto: "写真を開く",
  journalPhotoPosition: "{total}枚中{current}枚目の写真",
  previous: "前へ",
  // State of Mind
  ...
  orbPreparationError: "気分の記録を開けませんでした。もう一度お試しください。",
  journalMapLabel: "マップ",
  ...
  planningModeToday: "今日",
  planningModeSchedule: "予定",
  planningModeFocus: "集中",
  planningModeReview: "振り返り",
  planningActionTitle: "次の一歩",
  planningActionAddEvent: "予定に追加",
  planningActionStartFocus: "集中を始める",
  planningActionReview: "振り返る",
  planningActionOpenSchedule: "予定を開く",
  planningIntent_add_first_event: "今日の最初の予定を置きましょう。",
  planningIntent_prepare_next_event: "次の予定に備えましょう。",
  planningIntent_continue_current_event: "今の予定に集中しましょう。",
  planningIntent_start_focus_gap: "空いた時間を集中に使えます。",
  planningIntent_resume_focus: "集中タイマーが動いています。",
  planningIntent_review_recent_focus: "直近の集中セッションを記録しましょう。",
  planningIntent_resolve_conflict: "予定の重なりを確認しましょう。",
  planningIntent_close_day: "短い振り返りで一日を閉じましょう。",
  planningPulseTitle: "今日の流れ",
  planningPulseEvents: "予定",
  planningPulseFocus: "集中",
  planningPulseHabits: "習慣",
  planningPulseMood: "気分",
  planningPulseConflicts: "重なり",
  planningPulseMoodDone: "記録済み",
  planningPulseMoodOpen: "未記録",
  planningPulseHabitCount: "残り{count}件",
  planningPulseConflictCount: "{count}件",
  planningBridgeTitle: "次にできること",
  planningBridgeLogMood: "気分を記録",
  planningBridgeLogMoodDesc: "一日が進む前に、今の自分を確認します。",
  planningBridgeCompleteHabits: "習慣を終える",
  planningBridgeCompleteHabitsDesc: "今日まだ残っているループを閉じます。",
  planningBridgeReflectDiary: "日記で振り返る",
  planningBridgeReflectDiaryDesc: "今日をあとで読み返せるメモにします。",
  planningBridgePlanTomorrow: "明日を計画",
  planningBridgePlanTomorrowDesc: "次の日のために明確な軸を一つ残します。",
  ...
  orbAmbienceLabel: "穏やかな水音",
  orbAmbiencePlay: "穏やかな水音を再生",
  orbAmbiencePause: "穏やかな水音を一時停止",
  diaryAmbienceLabel: "やわらかな雨音",
  diaryAmbiencePlay: "やわらかな雨音を再生",
  diaryAmbiencePause: "やわらかな雨音を一時停止",
  // Phase 3-A.4b
  ...
  orbConfirm: "保存",
  orbSaveMoodAndStartEntry: "気分を保存して今日の記録を始める",
  orbSkip: "あとで",
  orbUndo: "取り消す",
