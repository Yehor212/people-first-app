...
export const ja: Translations = {
  ...
  errorBoundarySafeBody:
    "復旧モードはこの画面だけを停止しました。直近のエラーはこのデバイスに保存されました。",
  ...
  // Database recovery
  databaseRecoveryTitle: "このデバイスのデータがリセットされました",
  databaseRecoveryDesc:
    "このデバイスの保存領域がクリアされました。オンラインバックアップからデータの復元を試みます。",
  databaseRecoveryRestore: "オンラインバックアップから復元",
  ...
  offlineBannerPending: "オンライン保存を待っている変更",
