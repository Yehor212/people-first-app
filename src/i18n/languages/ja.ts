...
export const ja: Translations = {
  ...
  settingsSoundCrossPlatformNote: "共通サウンドマニフェストは Web、PWA、Android、iOS、Desktop を対象にし、リリース前にパッケージ成果物を確認します。",
  ...
  journalLoadFailedHint: "エントリーは消えていません。もう一度読み込んでください。",
  journalLoadFailed: "日記を読み込めませんでした",
