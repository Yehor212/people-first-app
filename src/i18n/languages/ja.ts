...
export const ja: Translations = {
  ...
  ...defineJournalRecoveryTranslations([
    "この機能はZenFlowの設定でオフになっています。",
    "ZenFlowでの記録がもう少し増えると、この機能が表示されます。",
    "ZenFlowが最近の記録を確認しています。少し待ってからもう一度お試しください。",
    "この端末では最近の記録を確認できませんでした。データは変更されていません。もう一度お試しください。",
    "一時的に表示できない日記の記録：{count}件。ほかの記録は引き続き表示されています。",
    "現在、日記の記録を表示できません。保存済みのデータは削除されていません。",
    "現在表示できない日記の記録：{count}件。保存済みのデータは削除されていません。",
    "もう一度読み込む",
    ...
    "日記をこのアカウントに関連付けています。アプリを開いたままサインイン状態を維持し、もう一度お試しください。変更はありません。",
    ...
    "アカウントを確認",
    "確認を開始しています...",
    "アカウント確認を開始できませんでした。変更は行われていません。接続を確認して、もう一度お試しください。",
    "この日記のアカウントを確認しています...",
    "ZenFlow は同じアカウントであることだけを確認し、日記やパスワードは変更しません。",
    "この日記のアカウントにログインして、確認を最初からやり直してください。変更は行われていません。",
    "この端末では、このアカウントに利用できるログイン方法がありません。アカウント設定を開き、先にログイン方法を確認してください。",
    "この日記のアカウントに登録されたメールアドレスへ確認リンクを送ります。",
    "この端末でリンクを開き、ZenFlow に戻ってください。アカウントは確認されますが、日記の保護は解除されません。",
    "アカウントを確認しました。必要なら日記をロック解除してから、保護の解除をもう一度お試しください。",
    "アカウントを確認しました",
    "必要なら日記をロック解除してから、保護の解除をもう一度お試しください。確認しただけでは、日記やパスワードは変更されません。",
    "閉じて日記をロック解除",
    "保護の解除をもう一度試す",
    "このアカウントの電話番号へ使い切りコードを送ります。確認しただけでは日記は変更されません。",
    "電話番号で確認",
    "使い切りの確認コードを送信",
    "コードを送信",
    "確認コードを入力",
    ...
    "6桁の確認コードを入力してください。",
    "確認する",
    "このアカウントにすでに連携済みのログイン方法を選んでください。保護の解除を明示的にやり直すまで、日記は変更されません。",
    "連携済みのログイン方法を使用",
    "{provider} で確認",
