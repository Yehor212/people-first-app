...
export const ja: Translations = {
  ...
  scheduleDayHasEvents: "予定があります",
  googleCalendarEventsLoading: "Google カレンダーの予定を読み込んでいます…",
  googleCalendarEventsUnavailable: "Google カレンダーの予定は現在利用できません。",
  scheduleStart: "開始",
  scheduleEnd: "終了",
  ...
  notificationPermissionTitle: "リマインダーを許可しますか？",
  notificationPermissionDescription:
    "ZenFlowは、設定でオンにした気分・集中・習慣のリマインダーを通知できます。",
  notificationFeature1Title: "気分リマインダー",
  notificationFeature1Desc: "選んだ曜日と時刻に通知します",
  notificationFeature2Title: "習慣リマインダー",
  notificationFeature2Desc: "各習慣に保存した曜日と時刻に通知します",
  notificationFeature3Title: "集中タイマー",
  notificationFeature3Desc: "時間を設定した集中セッションの終了時に通知します",
  notificationAllow: "リマインダーを許可",
  notificationDeny: "今はしない",
  ...
  hyperfocusToneLabel: "音色",
  hyperfocusToneHelp: "高周波のカットオフです。音程と再生速度は変わりません。",
  hyperfocusToneSofter: "より柔らかく",
  hyperfocusToneFullSpectrum: "全帯域",
  hyperfocusToneUnavailable: "このデバイスでは音色調整を利用できません。",
  hyperfocusSoundLevelSoft: "やさしい",
  hyperfocusSoundLevelDeep: "深い",
  hyperfocusSoundLevelIntense: "強い",
  ...
  navV2Archive: "アーカイブ",
  navV2Account: "アカウント",
  backgroundMusicTitle: "夜の音楽",
  backgroundMusicStateOn: "オン",
  backgroundMusicStateOff: "オフ",
  backgroundMusicStateLoading: "読み込み中",
  backgroundMusicStateBlocked: "タップして再開",
  backgroundMusicStateUnavailable: "利用できません",
  backgroundMusicPlayAction: "夜の音楽を再生",
  backgroundMusicPauseAction: "夜の音楽を一時停止",
  backgroundMusicPreviousAction: "前の曲",
  backgroundMusicNextAction: "次の曲",
  backgroundMusicStatePaused: "一時停止中",
  ...
  planningActionAddEvent: "予定を追加するためにスケジュールを開く",
  planningActionStartFocus: "集中タイマーを開く",
  ...
  navV2HabitsActionsFor: "「{habit}」の操作",
  ...
  featureUnavailableProgress:
    "この端末では、保存済みの日記の進み具合を確認できませんでした。アプリを再読み込みして、もう一度お試しください。データは削除されていません。",
  featureUnavailableDisabled:
    "このプロフィールでは、この機能がオフになっています。機能設定でオンにして、もう一度お試しください。",
  featureUnavailableUnlock:
    "この機能は、このプロフィールではまだ利用できません。既存のデータは変更されていません。",
  featureUnavailableGeneric:
    "この機能は一時的に利用できません。このメッセージを閉じ、しばらくしてからもう一度お試しください。",
};
