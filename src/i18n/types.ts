...
export interface Translations {
  // App
  appName: string;
  featureAvailabilityDisabledByUser: string;
  featureAvailabilityUnlockRequired: string;
  featureAvailabilityJournalCountLoading: string;
  featureAvailabilityJournalCountUnavailable: string;
  ...
  journalEntriesUnavailableAllCount: string;
  ...
  journalLockRemoveOwnerAdoptionPending: string;
  journalLockRemoveOwnerChanged: string;
  journalLockRemoveStorageFailed: string;
  journalLockRemoveFreshAuth: string;
  journalLockRemoveVerifyAccount: string;
  journalLockRemoveVerifyingAccount: string;
  journalLockRemoveReauthStartFailed: string;
  journalLockReauthChecking: string;
  journalLockReauthCheckingHint: string;
  journalLockReauthNoAccount: string;
  journalLockReauthMethodUnavailable: string;
  journalLockReauthConfirm: string;
  journalLockReauthCheckEmail: string;
  journalLockReauthVerified: string;
  journalLockReauthVerifiedTitle: string;
  journalLockReauthVerifiedDetail: string;
  journalLockReauthUnlockAction: string;
  journalLockReauthRetryAction: string;
  journalLockReauthPhoneDescription: string;
  journalLockReauthPhoneTitle: string;
  journalLockReauthPhoneConfirm: string;
  journalLockReauthPhoneSend: string;
  journalLockReauthPhoneCodeTitle: string;
  journalLockReauthPhoneCodeLabel: string;
  journalLockReauthPhoneCodeInvalid: string;
  journalLockReauthPhoneVerify: string;
  journalLockReauthProviderDescription: string;
  journalLockReauthProviderTitle: string;
  journalLockReauthProviderAction: string;
