...
export interface Translations {
  ...
  yourProgress: string;
  challengeProgressComplete: string;
  daysLeft: string;
  dayChallenge: string;
  ...
  challengeLookupUnavailable: string;
  challengeInviteOffline: string;
  challengeInviteNotFound: string;
  challengeInviteExpired: string;
  challengeInviteSelf: string;
  challengeInviteDuplicate: string;
  challengeInviteSignedOut: string;
  ...
  friendInviteInvalid: string;
  friendInviteSelf: string;
  friendInviteDuplicate: string;
  friendInviteOffline: string;
  friendInviteNotFound: string;
  friendInviteSignedOut: string;
  friendInviteUnavailable: string;
  friendProfilePreparing: string;
  friendProfileUnavailable: string;
  friendAdded: string;
  ...
  // Connected records
  connectedRecordsTitle: string;
  connectedRecordsDescription: string;
  connectedRecordsToggle: string;
  connectedRecordsToggleHint: string;
  connectedRecordsRulesTitle: string;
  connectedRecordsRulesDescription: string;
  connectedRecordsRuleMoodJournal: string;
  connectedRecordsRuleMoodJournalHint: string;
  connectedRecordsRuleJournalMood: string;
  connectedRecordsRuleJournalMoodHint: string;
  connectedRecordsRuleFocusHabit: string;
  connectedRecordsRuleFocusHabitHint: string;
  connectedRecordsRuleHabitPlanning: string;
  connectedRecordsRuleHabitPlanningHint: string;
  connectedRecordsPlanningMappingsTitle: string;
  connectedRecordsPlanningMappingsDescription: string;
  connectedRecordsPlanningHabitName: string;
  connectedRecordsPlanningBlockLabel: string;
  connectedRecordsPlanningBlockNone: string;
  connectedRecordsPlanningNoBlocks: string;
  connectedRecordsChoosePlanningBlockError: string;
  connectedRecordsFocusHabit: string;
  connectedRecordsChooseHabit: string;
  connectedRecordsChooseHabitError: string;
  connectedRecordsChooseRuleError: string;
  connectedRecordsSaveRules: string;
  connectedRecordsSaved: string;
  connectedRecordsSaveError: string;
  connectedRecordsHistory: string;
  connectedRecordsServiceUnavailable: string;
  connectedRecordsRequiresProtection: string;
  connectedRecordsRequiresOnline: string;
  connectedRecordsLoadError: string;
  connectedRecordsDisableError: string;
  connectedRecordsDisabled: string;
  connectedRecordsRevocationPending: string;
  connectedRecordsEnableTitle: string;
  connectedRecordsEnableDescription: string;
  connectedRecordsEnableDetail: string;
  connectedRecordsEnableConfirm: string;
  automationHistoryTitle: string;
  automationHistoryDescription: string;
  automationHistorySignInRequired: string;
  automationHistoryError: string;
  automationHistoryLoading: string;
  automationHistoryEmpty: string;
  automationHistoryActionError: string;
  automationHistoryVaultRequired: string;
  automationHistoryStatusConnected: string;
  automationHistoryStatusReverted: string;
  automationHistoryStatusPending: string;
  automationHistoryStatusNeedsReview: string;
  automationHistoryUndo: string;
  automationHistoryUndoPending: string;
  automationHistoryForget: string;
  automationHistoryForgetTitle: string;
  automationHistoryForgetDescription: string;
  automationHistoryForgetConfirm: string;
  automationHistoryClearAll: string;
  automationHistoryClearTitle: string;
  automationHistoryClearDescription: string;
  automationHistoryClearConfirm: string;
  innerWorld: string;
  ...
  storageTimeoutCached: string;
  storageTimeoutTitle: string;
  storageTimeoutUnavailable: string;
