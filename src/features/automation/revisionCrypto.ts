import { decryptJournalContent, encryptJournalContent } from "@/features/journal/journalCrypto";
import {
...
export async function decryptAutomationRevision(
  ...
  try {
    ...
    if (canonicalizeAutomationValue(innerBinding) !== canonicalizeAutomationValue(binding)) {
