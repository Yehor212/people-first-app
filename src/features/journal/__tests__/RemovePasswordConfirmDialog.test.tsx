...
const ts = {
  ...
  journalLockRemoveVerifyAccount: "Verify account",
...
describe("RemovePasswordConfirmDialog", () => {
  ...
  it("offers a direct account-verification action instead of retrying a stale session", async () => {
    const onConfirm = vi.fn().mockResolvedValue({
      status: "blocked",
      blocker: "fresh-auth-required",
      recoveryAction: "reauthenticate",
    });
    const onRecoveryAction = vi.fn().mockResolvedValue(undefined);
