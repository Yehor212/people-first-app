...
export function JournalStickerPackManager({
  ...
  return (
    <>
      {/* Backdrop */}
      <div className="fixed inset-0 z-[66] bg-black/40 animate-fade-in" onClick={onClose} />
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <motion.button
                    ...
                    aria-label={enabled ? (ts.journalStickerPackEnabled || 'Enabled') : (ts.journalStickerPackEnable || 'Tap to enable')}
                  >
                    <motion.div
                      layout
