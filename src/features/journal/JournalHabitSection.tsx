            ...
            <div className="px-3.5 pb-3 space-y-1">
              {snapshot.map(item => (
                <button
                  ...
                  className={cn(
                    'w-full flex items-center gap-2.5 py-2 px-2 rounded-lg motion-safe:transition-colors min-h-[44px]',
                ...
                >
                  {item.completed ? (
                    ...
                    <Circle className="w-4 h-4 text-muted-foreground/60 flex-shrink-0" aria-hidden="true" />
                  )}
