        ...
        {planted ? (
          ...
          <div className="flex items-center justify-center py-3" aria-live="polite">
            <div className="relative w-[90px] h-[140px]">
              ...
              <motion.div
                className="absolute w-[2.5px] h-[115px] bottom-2 left-1/2 -ml-[1.25px] rounded-[2px] origin-bottom shadow-[0_0_10px_2px_rgba(52,211,153,0.25)] bg-[linear-gradient(to_top,#059669,#34d399,#6ee7b7)]"
                initial={{ scaleY: 0 }}
                animate={{ scaleY: 1 }}
              ...
              <motion.div
                className="absolute w-3.5 h-5 bottom-12 left-[calc(50%+3px)] rounded-[50%_50%_0%_50%] origin-bottom-left shadow-[0_0_8px_1px_rgba(52,211,153,0.2)] bg-emerald-400"
                style={{ rotate: 25 }}
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <motion.div
                className="absolute w-3 h-[18px] bottom-[60px] right-[calc(50%+3px)] rounded-[50%_50%_50%_0%] origin-bottom-right shadow-[0_0_8px_1px_rgba(52,211,153,0.2)] bg-emerald-400"
                style={{ rotate: -25 }}
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
          ...
          <>
            <textarea
              ...
              className="w-full rounded-xl px-4 py-3 text-base font-hand italic outline-none resize-none bg-white/[0.03] dark:bg-white/[0.03] text-foreground/90 ring-1 ring-white/[0.06] focus:ring-emerald-500/20 placeholder:text-muted-foreground/60 motion-safe:transition-shadow min-h-16 leading-relaxed"
              rows={2}
              maxLength={500}
