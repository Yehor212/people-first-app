...
// SECURITY (OWASP M8): Sticker images loaded via <img src=> from jsdelivr CDN.
// CSP img-src restricts to 'self' data: blob: https: — only HTTPS sources allowed.
// Browser validates image format natively; non-image responses render as broken img (safe).
