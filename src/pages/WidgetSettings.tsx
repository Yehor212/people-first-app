    ...
    <div className="min-h-screen bg-background pb-20 scroll-pt-[120px]">
      ...
      <div className="sticky top-0 z-50 bg-background/95 backdrop-blur border-b">
        <div className="flex items-center gap-4 px-4 py-4 pt-safe">
          <button
            onClick={onBack}
            className="p-4 hover:bg-accent rounded-xl motion-safe:transition-colors active:scale-95 touch-manipulation"
            aria-label={t.back}
          >
        ...
        <div className="flex gap-2 px-6 pb-4">
          <button
            ...
            className={`flex-1 px-4 py-2 rounded-xl font-medium motion-safe:transition-all ${
              activeTab === "preview"
      ...
      <div className="px-6 py-6">
            ...
            <div className="bg-muted rounded-2xl p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    {isNativePlatform ? t.widgetAvailable : t.widgetComingSoon}
                  </span>
                </div>
              </div>
            </div>
        ...
        {activeTab === "setup" && (
          <div className="space-y-6">
              ...
              <>
                {isIos && (
                  <div className="space-y-4">
                    <h2 className="text-lg font-bold">{t.widgetSetupiOS}</h2>
                    <div className="bg-muted rounded-2xl p-6 space-y-4">
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm">{t.widgetStep1iOS}</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm">{t.widgetStep2iOS}</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm">{t.widgetStep3iOS}</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm">{t.widgetStep4iOS}</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm">{t.widgetStep5iOS}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="bg-muted rounded-2xl p-6 space-y-4">
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm">{t.widgetStep1Android}</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm">{t.widgetStep2Android}</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm">{t.widgetStep3Android}</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm">{t.widgetStep4Android}</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            {/* Features */}
            <div className="space-y-4">
              <h3 className="text-sm font-semibold">{t.widgetFeatures}:</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3 bg-muted rounded-xl p-3">
                  <div className="w-2 h-2 rounded-full bg-green-500 mt-2" />
                  <p className="text-sm">{t.widgetFeature1}</p>
                </div>
                <div className="flex items-start gap-3 bg-muted rounded-xl p-3">
                  <div className="w-2 h-2 rounded-full bg-green-500 mt-2" />
                  <p className="text-sm">{t.widgetFeature2}</p>
                </div>
                <div className="flex items-start gap-3 bg-muted rounded-xl p-3">
                  <div className="w-2 h-2 rounded-full bg-green-500 mt-2" />
                  <p className="text-sm">{t.widgetFeature3}</p>
                </div>
                <div className="flex items-start gap-3 bg-muted rounded-xl p-3">
                  <div className="w-2 h-2 rounded-full bg-green-500 mt-2" />
                  <p className="text-sm">{t.widgetFeature4}</p>
                </div>
                <div className="flex items-start gap-3 bg-muted rounded-xl p-3">
                  <div className="w-2 h-2 rounded-full bg-green-500 mt-2" />
                  <p className="text-sm">{t.widgetFeature5}</p>
                </div>
              </div>
            </div>
          </div>
