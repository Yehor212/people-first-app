...
public class WidgetProviderMedium extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        String insight = getSmartInsight(streak, habitsToday, habitsTotalToday, focusMinutes);
     ...
     */
    private static String getSmartInsight(int streak, int habitsToday, int habitsTotalToday, int focusMinutes) {
        // Streak milestones
