...
interface AndroidEntryScenario {
...
const OUTPUT_DIR = path.resolve(process.cwd(), "output/playwright/android-entry-20260615");
const SUPPORTED_LANGUAGES: readonly EntryLanguage[] = ["en", "uk", "es", "de", "fr", "ja", "ar", "he"];
const RTL_LANGUAGES = new Set<EntryLanguage>(["ar", "he"]);

const scenarios: AndroidEntryScenario[] = [
  {
    name: "android-phone-language-light",
    fileName: "android-phone-language-light.png",
    screen: "language",
    theme: "paper",
    language: "en",
    colorScheme: "light",
  ...
  {
    name: "android-phone-language-dark",
    fileName: "android-phone-language-dark.png",
    screen: "language",
    theme: "ink",
    language: "en",
    colorScheme: "dark",
  ...
  {
    name: "android-phone-language-ar-rtl",
    fileName: "android-phone-language-ar-rtl.png",
    screen: "language",
    theme: "paper",
    language: "ar",
    colorScheme: "light",
  ...
  {
    name: "android-phone-language-he-rtl",
    fileName: "android-phone-language-he-rtl.png",
    screen: "language",
    theme: "paper",
    language: "he",
    colorScheme: "light",
  ...
  {
    name: "android-phone-auth-light",
    fileName: "android-phone-auth-light.png",
    screen: "auth",
    theme: "paper",
    language: "en",
    colorScheme: "light",
  ...
  {
    name: "android-phone-auth-dark",
    fileName: "android-phone-auth-dark.png",
    screen: "auth",
    theme: "ink",
    language: "en",
    colorScheme: "dark",
  ...
  {
    name: "android-tablet-language-system",
    fileName: "android-tablet-language-system.png",
    screen: "language",
    theme: "auto",
    language: "en",
    colorScheme: "dark",
  ...
  {
    name: "android-tablet-language-dark",
    fileName: "android-tablet-language-dark.png",
    screen: "language",
    theme: "ink",
    language: "en",
    colorScheme: "dark",
  ...
  {
    name: "android-tablet-auth-dark",
    fileName: "android-tablet-auth-dark.png",
    screen: "auth",
    theme: "ink",
    language: "en",
    colorScheme: "dark",
...
async function primeEntryState(page: Page, scenario: AndroidEntryScenario) {
...
test.describe("Android entry gate evidence", () => {
  test("captures the current Android phone and tablet entry matrix", async ({
    browser,
    browserName,
  }, testInfo) => {
    ...
    expect(baseURL, "Android entry evidence baseURL").toContain("/people-first-app/");
    ...
    for (const scenario of scenarios) {
      ...
      verificationLines.push(
        `${scenario.name}: screen=${fact.screen} selectedTheme=${fact.selectedTheme} ` +
          ...
          `logoNatural=${fact.logo.naturalWidth}x${fact.logo.naturalHeight} ` +
    ...
    for (const fact of facts) {
      ...
      expect(fact.logo.naturalWidth, `${fact.name} logo natural width`).toBeGreaterThanOrEqual(256);
      expect(fact.logo.naturalHeight, `${fact.name} logo natural height`).toBeGreaterThanOrEqual(256);
      ...
      if (fact.name === "android-phone-language-ar-rtl") {
      ...
      if (fact.name === "android-phone-language-he-rtl") {
  ...
  test("keeps every supported language usable on Android phone Chromium", async ({
    browser,
    browserName,
  }, testInfo) => {
    test.setTimeout(180_000);
    ...
    expect(baseURL, "Android all-language smoke baseURL").toContain("/people-first-app/");

    for (const language of SUPPORTED_LANGUAGES) {
      const scenario: AndroidEntryScenario = {
        name: `android-phone-language-${language}-smoke`,
        fileName: `android-phone-language-${language}-smoke.png`,
        screen: "language",
        theme: "paper",
        language,
        colorScheme: "light",
