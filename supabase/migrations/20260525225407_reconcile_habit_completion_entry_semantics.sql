-- Reconciliation migration for remote drift:
-- 20260505053700_habit_completion_entry_semantics.sql exists locally but was
-- absent from remote history, and remote schema evidence on 2026-05-25 showed
-- the habit completion semantic columns/constraints/index were still missing.
-- Keep this migration idempotent so it can safely converge the linked project
-- without replaying historical duplicate-prefix drift.
