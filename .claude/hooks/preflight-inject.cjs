...
const PREFLIGHT_PROTOCOL = [
  ...
  '  Layer 1: Local code (src/, hooks, tests, scripts)',
  '  Layer 2: Backend (Supabase MCP: api, auth, edge-functions, postgres, storage, realtime, cron, rls)',
  '  Layer 3: External services (Firebase, push notifications, analytics)',
  '  Layer 4: CI/CD (GitHub Actions, build, deploy)',
  '  Layer 5: User-facing (app behavior, performance, accessibility)',
