...
| TD-09 | ~~HIGH~~ → MEDIUM | Low test coverage | **Phase 2 done 2026-02-17**: 1006 → **1273 tests** (+267). Added 10 new files: utils (54), appVersion (21), cloudSyncSettings (11), authGuard (25), feedbackService (18), accountService (31), apiClient (48), cloudSync (34), FeatureFlagsContext (13), LanguageContext (12). 47 test files total. Phase 3 TODO: hooks (useFocusTimer, useHabitHandlers), remaining sync modules. | src/**/__tests__/ |
